...
IntTy sumLeft(CursorTy m_34_689_917);
      ...
      case 1:
        {
            ...
            IntTy fltPrm_852_923 =  sumLeft(l_38_693_921);
            IntTy fltPrm_851_924 = fltPrm_852_923 + v_37_692_920;
            IntTy fltPrm_853_925 =  sumLeft(r_39_694_922);
...
int __main_expr()
{
    ...
    CursorTy m_25_682_910 =  build(0, 10, fltAppE_850_909);
    IntTy timed_1136;
    ...
    for (long long iters_timed_1136 = 0; iters_timed_1136 < global_iters_param;
        ...
        IntTy timed_1136hack =  sumLeft(m_25_682_910);
    ...
    for (long long iters_timed_1137 = 0; iters_timed_1137 < global_iters_param;
        ...
        IntTy timed_1137hack =  sumLeft(m_25_682_910);
