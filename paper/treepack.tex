...
Finally, what becomes of the \il{case} expression?
  \il{$\llbracket$case v of K x y -> e2 $\rrbracket$} is
translated to:
...
required.  In both packed and pointer mode, we use coarse-grained arena
allocation and deallocation.  But our region inference is currently quite simple
