...
\new{This representation is efficient for random access and shape-changing
  modifications, but for traversals that process all or most of a tree in bulk}---including
%
compiler passes, space-partitioning trees, and
elsewhere---\new{it can be inefficient.
%
