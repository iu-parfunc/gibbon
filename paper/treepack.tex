...
\begin{code}
  ...
  add1'' cin cout =
    switch cin of
      Leaf end1 -> let cout2    = write(LEAF,cout) in
                   let (end2,n) = read(end1) in
                   let cout3    = write(cout2, n+1) in
                   (end2, coerce(cout3))
      Node end1 -> let cout2         = write(NODE,cout) in
                   let (end2, cout3) = add1'' end1 cout2 in
                   let (end3, cout4) = add1'' end2 cout3 in
                   (end3, coerce(cout4))
\end{code}
