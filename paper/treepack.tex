...
using Racket's language implmenetation and extension
...
use  packed data to represent all type declared using the
\texttt{data} form.  
...
\treelang{}'s approach is to convert programs into a form of {\em destination
  passing style}~\cite{larus89}, except where destinations are not per-data-constructor, but
