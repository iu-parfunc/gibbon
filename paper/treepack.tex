...
\begin{displaymath}
  \begin{aligned}
    ...
    \keywd{t} \gramdef & \keywd{int} \gramor \keywd{cursor} \gramor \keywd{prod} \keywdr{t} \\
    & \gramor \keywd{sum} \keywdr{(v,t)} \\
    \keywd{e} \gramdef & \keywd{x} \gramor \keywd{prim} \keywdr{x} \\
    & \gramor \keywd{tup} \keywdr{x} \gramor \keywd{proj} \keywd{n} \keywd{x}  \\
