...
To simulate larger programs (as found in whole-program compilation), we
...
First, our benchmark methodology is to run traverse each input tree $N$ times,
...
pointer (malloc) and bumpalloc modes.  We measured the last level cache
...
%
Yet nevertheless the performance of pointer-based approaches is good at small
...
\note{Phase shift from in cache to out of cache}
