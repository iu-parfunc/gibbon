...
\author[5]{Milind Kulkarni}
\author[6]{Sam Tobin-Hochstadt}
\author[7]{Ryan Newton}
\affil[1]{Indiana University \\ vollmerm@indiana.edu}
\affil[2]{Indiana University \\ sjspall@indiana.edu}
\affil[3]{Indiana University \\ budkahaw@indiana.edu}
\affil[4]{Purdue University \\ lsakka@purdue.edu}
\affil[5]{Purdue University \\ milind@purdue.edu}
\affil[6]{Indiana University \\ samth@indiana.edu}
\affil[7]{Indiana University \\ rrnewton@indiana.edu}
...
worse run-time complexity. On tree sizes of the sizes measured in \cref{fig:shootout1},
the generated packed code runs roughly $6\times$ slower than the pointer code.
%
