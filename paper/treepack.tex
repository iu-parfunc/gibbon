...
Finally, before we proceed, note that the original textual order of the program
...
\begin{code}
  sum1 t = case t of Node n -> n | Leaf x y -> sum1 y + sum1 x
  sum2 t = case t of Node n -> n | Leaf x y -> sum2 x + sum2 y
\end{code}
...
Finally, what becomes of the \il{case} expression?  \il{case v of K x y -> e2} is
translated to:
