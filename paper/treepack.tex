...
\begin{figure}
  ...
  \begin{displaymath}
    \begin{aligned}
      \keywd{program} \gramdef & \keywdr{tdecl} \keywdr{fdecl} \keywd{e} \\
      \keywd{tdecl} \gramdef & \keywd{(nam,t)} \\
      \keywd{fdecl} \gramdef & \keywd{nam} \keywdr{arg} \keywd{t} \keywd{e} \\
      \keywd{t} \gramdef &  \keywd{int} \gramor \keywd{t * t}  \gramor \keywd{t + t} \\
      \gramor & \keywd{t} \rightarrow \keywd{t} \\
      \keywd{e} \gramdef & todo
    \end{aligned}
  \end{displaymath}
...
\begin{displaymath}
  \begin{aligned}
    ...
    \gramor & \keywd{t + t} \gramor \keywd{t} \rightarrow \keywd{t} \\
    \keywd{e} \gramdef & \keywd{x} \gramor \keywd{prim} \keywd{p} \keywdr{x} \\
    \gramor & \keywdr{(x,x)} \gramor \keywd{n} @ \keywd{x}  \\
    \gramor & \keywd{let} \keywdr{(v,t,e)} \keywd{e} \\
