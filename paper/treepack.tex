...
The overall structure of the compiler, covered throughout the rest of this
section, is:

\begin{itemize}
\item Infer traversal effects.
% \item Copy and traversal insertion 
\item Routing end-of-value witnesses.
\item Switch fully to destination cursor-passing.
