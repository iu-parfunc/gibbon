...
\begin{figure}
  \begin{displaymath}
    \keywd{v,nam,arg} \in \; Var, \:
    \keywd{n} \in \; Int, \: \keywd{p} \in \; Prim, \: c \in \; Tag
  \end{displaymath}
  \begin{displaymath}
    \begin{aligned}
      \keywd{prog} \gramdef & \keywdr{tdecl} \keywdr{fdecl} \keywd{e} \\
      \keywd{tdecl} \gramdef & \keywd{(nam,t)} \\
      \keywd{fdecl} \gramdef & \keywd{nam} \keywdr{arg} \keywd{t} \keywd{e} \\
      \keywd{t} \gramdef & \keywd{t'} \rightarrow \keywd{t'} \gramor \keywd{t'} \\
      \keywd{t'} \gramdef &  \keywd{int} \gramor \keywd{t' * t'}  \\
      \gramor & \keywd{t' + t'} \\
      \keywd{e} \gramdef & \keywd{v} \gramor \keywd{n} \gramor \keywd{e} \keywd{p} \keywd{e} \\
      \gramor & \keywd{(e,e)} \gramor \keywd{n} @ \keywd{x} \\
      \gramor & \keywd{let} \keywd{(v,t,e)} \keywd{e} \\
      \gramor & \keywd{case} \keywd{e} \keywdr{(c,v,e)} \\
    \end{aligned}
  \end{displaymath}
...
\begin{displaymath}
  \begin{aligned}
    ...
    \keywd{t} \gramdef & \keywd{t'} \rightarrow \keywd{t'} \gramor \keywd{t'} \\
    \keywd{t'} \gramdef & \keywd{int} \gramor \keywd{cursor} \gramor \keywd{t' * t'} \\
    \keywd{e} \gramdef & \keywd{x} \gramor \keywd{x} \keywd{p} \keywd{x} \gramor \keywd{v} \keywd{x} \\
    \gramor & \keywd{(x,x)} \gramor \keywd{n} @ \keywd{x} \\
    \gramor & \keywd{let} \keywd{(v,t,e)} \keywd{e} \\
