...
%
\new{This representation is efficient for random access and shape-changing
  modifications, but for traversals, such as compiler passes, that process most or all of a tree in bulk
...
%
{For map- and fold-style traversals, packed data allows speedups of over
  $2\times$ compared to a highly-optimized pointer-based baseline.}
