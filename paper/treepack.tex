...
%% consumes and produces a tree.
  ...
  packed.  
%
{Also, over these benchmarking runs, at these tree sizes, the pointer-based
...
the generated packed code runs $150\times$ slower than the pointer code (and
arbitrarily slower on progressively larger trees).
%
...
them to packed implementations. We also discuss extensions to \treelang{}'s
representation that
introduces selective random access to packed tree nodes,
