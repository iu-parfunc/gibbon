...
@.str.1 = private unnamed_addr constant [16 x i8] c"SELFTIMED: %lf\0A\00", align 1
@.str.2 = private unnamed_addr constant [16 x i8] c"BATCHTIME: %lf\0A\00", align 1
@.str.3 = private unnamed_addr constant [28 x i8] c"Error, key %lld not found!\0A\00", align 1
@global_benchfile_param = internal global i8* null, align 8
@stderr = external global %struct._IO_FILE*, align 8
@.str.4 = private unnamed_addr constant [57 x i8] c"read_benchfile_param: benchmark input file was not set!\0A\00", align 1
@.str.5 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@.str.6 = private unnamed_addr constant [51 x i8] c"This binary was generated by the Gibbon compiler.\0A\00", align 1
@.str.7 = private unnamed_addr constant [33 x i8] c"Usage: %s [OPTS] [size] [iters]\0A\00", align 1
@.str.8 = private unnamed_addr constant [10 x i8] c"Options:\0A\00", align 1
@.str.9 = private unnamed_addr constant [65 x i8] c" --buffer-size <bytes>      Set the buffer size (default %lld).\0A\00", align 1
@global_default_buf_size = internal global i64 5000000000, align 8
@.str.10 = private unnamed_addr constant [84 x i8] c" --bench-input <path>       Set the input file read for benchmarking. Applies only\0A\00", align 1
@.str.11 = private unnamed_addr constant [78 x i8] c"                            IF the program was *compiled* with --bench-fun. \0A\00", align 1
@.str.12 = private unnamed_addr constant [44 x i8] c" [gibbon rts] failed to getrlimit, code %d\0A\00", align 1
@.str.13 = private unnamed_addr constant [57 x i8] c" [gibbon rts] Failed to set stack size to %llu, code %d\0A\00", align 1
@.str.14 = private unnamed_addr constant [79 x i8] c" [gibbon rts] Failed setrlimit stack size to something reasonable; giving up.\0A\00", align 1
@.str.15 = private unnamed_addr constant [3 x i8] c"-h\00", align 1
@.str.16 = private unnamed_addr constant [7 x i8] c"--help\00", align 1
@.str.17 = private unnamed_addr constant [14 x i8] c"--buffer-size\00", align 1
@.str.18 = private unnamed_addr constant [14 x i8] c"--bench-input\00", align 1
@.str.19 = private unnamed_addr constant [52 x i8] c"Not enough arguments after -file, expected <file>.\0A\00", align 1
@.str.20 = private unnamed_addr constant [28 x i8] c"Extra arguments left over: \00", align 1
@.str.21 = private unnamed_addr constant [4 x i8] c"%s \00", align 1
@global_size_param = external global i64, align 8
@global_iters_param = external global i64, align 8

; Function Attrs: nounwind uwtable
define i32 @__print_int(i64) #0 {
...
; Function Attrs: nounwind uwtable
define i32 @__print_difftime(double) #0 {
  %2 = alloca double, align 8
  store double %0, double* %2, align 8
  %3 = load double, double* %2, align 8
  %4 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.1, i32 0, i32 0), double %3)
  ret i32 %4
}

; Function Attrs: nounwind uwtable
define i32 @__print_iter_difftime(double) #0 {
  %2 = alloca double, align 8
  store double %0, double* %2, align 8
  %3 = load double, double* %2, align 8
  %4 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.2, i32 0, i32 0), double %3)
  ret i32 %4
}
...
; <label>:26:                                     ; preds = %5
  ...
  %28 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.3, i32 0, i32 0), i64 %27)
...
; <label>:3:                                      ; preds = %0
  ...
  %5 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %4, i8* getelementptr inbounds ([57 x i8], [57 x i8]* @.str.4, i32 0, i32 0))
  call void @exit(i32 1) #6
  unreachable
...
define void @show_usage(i8**) #0 {
  ...
  %4 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([51 x i8], [51 x i8]* @.str.6, i32 0, i32 0))
  %5 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.5, i32 0, i32 0))
  %6 = load i8**, i8*** %2, align 8
  %7 = getelementptr inbounds i8*, i8** %6, i64 0
  %8 = load i8*, i8** %7, align 8
  %9 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.7, i32 0, i32 0), i8* %8)
  %10 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.5, i32 0, i32 0))
  %11 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.8, i32 0, i32 0))
  %12 = load i64, i64* @global_default_buf_size, align 8
  %13 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([65 x i8], [65 x i8]* @.str.9, i32 0, i32 0), i64 %12)
  %14 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([84 x i8], [84 x i8]* @.str.10, i32 0, i32 0))
  %15 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([78 x i8], [78 x i8]* @.str.11, i32 0, i32 0))
  ret void
}
...
; <label>:13:                                     ; preds = %2
  ...
  %16 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %14, i8* getelementptr inbounds ([44 x i8], [44 x i8]* @.str.12, i32 0, i32 0), i32 %15)
  call void @abort() #6
  unreachable
...
; <label>:23:                                     ; preds = %20
  ...
  %28 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %24, i8* getelementptr inbounds ([57 x i8], [57 x i8]* @.str.13, i32 0, i32 0), i64 %26, i32 %27)
...
; <label>:35:                                     ; preds = %23
  ...
  %37 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %36, i8* getelementptr inbounds ([79 x i8], [79 x i8]* @.str.14, i32 0, i32 0))
  br label %40
...
; <label>:45:                                     ; preds = %41
  ...
  %51 = call i32 @strcmp(i8* %50, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.15, i32 0, i32 0)) #7
  %52 = icmp eq i32 %51, 0
...
; <label>:53:                                     ; preds = %45
  ...
  %59 = call i32 @strcmp(i8* %58, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.16, i32 0, i32 0)) #7
  %60 = icmp eq i32 %59, 0
...
; <label>:63:                                     ; preds = %53
  ...
  %69 = call i32 @strcmp(i8* %68, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.17, i32 0, i32 0)) #7
  %70 = icmp eq i32 %69, 0
...
; <label>:86:                                     ; preds = %71, %63
  ...
  %92 = call i32 @strcmp(i8* %91, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.18, i32 0, i32 0)) #7
  %93 = icmp eq i32 %92, 0
...
; <label>:99:                                     ; preds = %94
  ...
  %101 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %100, i8* getelementptr inbounds ([52 x i8], [52 x i8]* @.str.19, i32 0, i32 0))
...
; <label>:115:                                    ; preds = %112
  ...
  %117 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %116, i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.20, i32 0, i32 0))
  br label %118
...
; <label>:122:                                    ; preds = %118
  ...
  %129 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %123, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.21, i32 0, i32 0), i8* %128)
  br label %130
