...
emphKeywordInTag keyword blogs = case blogs of 
                                    End -> End
                                    Layout4 tags content rst header id author date -> let present     = searchBlogTags keyword tags -- search the tags for the keyword 
                                                                                        ...
                                                                                        in Layout4 (copyPacked tags) (copyPacked newContent) (copyPacked newRst) (header) id author date
...
gibbon_main = 
    let 
        ...
        blogs     = mkBlogs_layout4 lfc ltc 10000
        --_ = printPacked blogs
        --_ = printsym (quote "NEWLINE")
        --_ = printsym (quote "NEWLINE")
        keyword :: Vector Char  
