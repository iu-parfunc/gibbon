...
# The experiment trees are siblings of this script, so anchor to its own
# directory rather than reconstructing a path from the repo root.
EXPERIMENTS_DIR = Path(__file__).resolve().parent
RESULT_ROOTS = [
    EXPERIMENTS_DIR / "simple_test" / "results",
    EXPERIMENTS_DIR / "scalar_count_smoke" / "results",
]
