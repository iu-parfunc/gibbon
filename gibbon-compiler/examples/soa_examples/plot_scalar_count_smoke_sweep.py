...
# This script lives in gibbon-compiler/examples/soa_examples/; the repo root is
# three levels up (soa_examples -> examples -> gibbon-compiler -> repo root).
# The experiment driver it shells out to is now a sibling, under experiments/.
SOA_DIR = Path(__file__).resolve().parent
REPO_ROOT = SOA_DIR.parents[2]
BENCH = SOA_DIR / "experiments" / "scalar_count_smoke" / "benchmark_scalar_count_smoke.py"
