...
void sumTree(GibCursor cursor_ptr_1549[3],
      ...
      case 1:
        {
            ...
            *loc_IntTy_620 += 8;
            ...
            add1Tree(cursor_ptr_1322, cursor_ptr_1321, cursor_ptr_1323, t_31_136_213);
      ...
      case GIB_REDIRECTION_TAG:
        {
            ...
            *soa_field_1_1413 = tmpcur_2192;
            ...
            add1Tree(t_31_136_213, cursor_ptr_1321, cursor_ptr_1323, t_31_136_213);
      ...
      case 0:
        {
            ...
            *soa_field_0_1555 += sizeof(GibInt);
      ...
      case 1:
        {
            ...
            *soa_field_1_1562 += sizeof(GibInt);
            ...
            *Res += tmpval_2284;
            sumTree(cursor_ptr_1549, tr_36_150_231, Res);
      ...
      case GIB_REDIRECTION_TAG:
        {
            ...
            uintptr_t tagged_tmpcur_41 = *(uintptr_t *) (*dcon_1553);
            GibCursor tmpcur_2304 = GIB_UNTAG(tagged_tmpcur_41);
            *dcon_1553 = tmpcur_2304;
...
int main(int argc, char **argv)
{
    ...
    for (long long iters_pvrtmp_2121 = 0; iters_pvrtmp_2121 <
        ...
        add1Tree(pvrtmp_2100, reg_cursor_ptr_1926, reg_ptr_1925, pvrtmp_2101);
...
//         memcpy(pvrtmp_2123, pvrtmp_2114, sizeof(GibCursor [3]));
        ...
        memcpy(pvrtmp_2122, reg_ptr_1925, sizeof(GibCursor [3]));
    ...
    for (long long iters_timed_1992 = 0; iters_timed_1992 <
        ...
        GibInt Res = 0;
        sumTree(reg_cursor_ptr_1926, pvrtmp_2122, &Res);
