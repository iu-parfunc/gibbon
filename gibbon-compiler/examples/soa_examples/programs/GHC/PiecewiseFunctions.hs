...
gibbon_main = do
  _ <- printsymIO (quote "Running Program Piecewise Functions (MADNESS style): ")
  _ <- printsymIO (quote "NEWLINE")
  let pfTree = buildPW (sizeParam + 23) 17
  _ <- printsymIO (quote "Running pass norm2Estimate (fold, uses=5): ")
  _ <- printsymIO (quote "NEWLINE")
  norm <- iterateIO (\() -> norm2Estimate pfTree)
  _ <- printsymIO (quote "End")
  _ <- printsymIO (quote "NEWLINE")
  _ <- printsymIO (quote "Running pass truncateTolViolations (fold, uses=3): ")
  _ <- printsymIO (quote "NEWLINE")
  refineCnt <- iterateIO (\() -> truncateTolViolations pfTree 18)
  _ <- printsymIO (quote "End")
  _ <- printsymIO (quote "NEWLINE")
  _ <- printsymIO (quote "Running pass compressMass (fold, uses=3): ")
  _ <- printsymIO (quote "NEWLINE")
  mass <- iterateIO (\() -> compressMass pfTree)
  _ <- printsymIO (quote "End")
  _ <- printsymIO (quote "NEWLINE")
  _ <- printsymIO (quote "Running pass autorefineMaxLevel (fold, uses=4): ")
  _ <- printsymIO (quote "NEWLINE")
  maxLvl <- iterateIO (\() -> autorefineMaxLevel pfTree)
  _ <- printsymIO (quote "End")
  _ <- printsymIO (quote "NEWLINE")
  _ <- printsymIO (quote "Running pass pmapCutHistogram (fold, uses=4): ")
  _ <- printsymIO (quote "NEWLINE")
  pmapCuts <- iterateIO (\() -> pmapCutHistogram pfTree 500)
  _ <- printsymIO (quote "End")
  _ <- printsymIO (quote "NEWLINE")
  _ <- printsymIO (quote "Running pass lbDeuxLoadProxy (fold, uses=5): ")
  _ <- printsymIO (quote "NEWLINE")
  loadW <- iterateIO (\() -> lbDeuxLoadProxy pfTree)
  _ <- printsymIO (quote "End")
  _ <- printsymIO (quote "NEWLINE")
  _ <- printsymIO (quote "Running pass addConstPW (map, uses=8): ")
  _ <- printsymIO (quote "NEWLINE")
  shifted <- iterateIO (\() -> addConstPW pfTree 10)
  _ <- printsymIO (quote "End")
  _ <- printsymIO (quote "NEWLINE")
  _ <- printsymIO (quote "Running pass diffPW (map, uses=8): ")
  _ <- printsymIO (quote "NEWLINE")
  _diffed <- iterateIO (\() -> diffPW shifted)
  _ <- printsymIO (quote "End")
  _ <- printsymIO (quote "NEWLINE")
  let massShift = compressMass shifted
  let massDiff = compressMass _diffed
  return ((norm, refineCnt, mass, maxLvl, pmapCuts, loadW, massShift, massDiff))
