...
gibbon_main = do
  _ <- printsymIO (quote "Running Data base Query Pass: ")
  _ <- printsymIO (quote "NEWLINE")
  let queryTree = buildQuery (sizeParam + 75) 17
  _ <- printsymIO (quote "Running pass sumCost (fold, uses=6): ")
  _ <- printsymIO (quote "NEWLINE")
  totCost <- iterateIO (\() -> sumCost queryTree)
  _ <- printsymIO (quote "End")
  _ <- printsymIO (quote "NEWLINE")
  _ <- printsymIO (quote "Running pass sumRows (fold, uses=6): ")
  _ <- printsymIO (quote "NEWLINE")
  totRows <- iterateIO (\() -> sumRows queryTree)
  _ <- printsymIO (quote "End")
  _ <- printsymIO (quote "NEWLINE")
  _ <- printsymIO (quote "Running pass countJoins (fold, uses=3): ")
  _ <- printsymIO (quote "NEWLINE")
  totJoins <- iterateIO (\() -> countJoins queryTree)
  _ <- printsymIO (quote "End")
  _ <- printsymIO (quote "NEWLINE")
  _ <- printsymIO (quote "Running pass sumMemory (fold, uses=6): ")
  _ <- printsymIO (quote "NEWLINE")
  totMem <- iterateIO (\() -> sumMemory queryTree)
  _ <- printsymIO (quote "End")
  _ <- printsymIO (quote "NEWLINE")
  _ <- printsymIO (quote "Running pass hashJoinPressure (fold, uses=5): ")
  _ <- printsymIO (quote "NEWLINE")
  hashPressure <- iterateIO (\() -> hashJoinPressure queryTree)
  _ <- printsymIO (quote "End")
  _ <- printsymIO (quote "NEWLINE")
  _ <- printsymIO (quote "Running pass filterSelectivitySkew (fold, uses=5): ")
  _ <- printsymIO (quote "NEWLINE")
  selSkew <- iterateIO (\() -> filterSelectivitySkew queryTree)
  _ <- printsymIO (quote "End")
  _ <- printsymIO (quote "NEWLINE")
  _ <- printsymIO (quote "Running pass scaleCosts (map, uses=15): ")
  _ <- printsymIO (quote "NEWLINE")
  queryTree' <- iterateIO (\() -> scaleCosts queryTree 10)
  _ <- printsymIO (quote "End")
  _ <- printsymIO (quote "NEWLINE")
  _ <- printsymIO (quote "Running pass clearQueryFlags (map, uses=14): ")
  _ <- printsymIO (quote "NEWLINE")
  queryTree'' <- iterateIO (\() -> clearQueryFlags queryTree')
  _ <- printsymIO (quote "End")
  _ <- printsymIO (quote "NEWLINE")
  let mapCost1 = sumCost queryTree'
  let mapCost2 = sumCost queryTree''
  return ((totCost, totRows, totJoins, totMem, hashPressure, selSkew, mapCost1, mapCost2))
