...
gibbon_main = do
  _ <- printsymIO (quote "Running program DomTree: ")
  _ <- printsymIO (quote "NEWLINE")
  let tree   = buildRenderTree (sizeParam + 23)
  let tree_smaller = buildRenderTree (sizeParam + 20)
  _ <- printsymIO (quote "Running pass SumArea (fold, uses=6): ")
  _ <- printsymIO (quote "NEWLINE")
  area <- iterateIO (\() -> sumArea tree)
  _ <- printsymIO (quote "End")
  _ <- printsymIO (quote "NEWLINE")
  _ <- printsymIO (quote "Running pass find max Bottom (fold, uses=5): ")
  _ <- printsymIO (quote "NEWLINE")
  bottom <- iterateIO (\() -> maxBottom tree)
  _ <- printsymIO (quote "End")
  _ <- printsymIO (quote "NEWLINE")
  _ <- printsymIO (quote "Running pass count styled (fold, uses=3): ")
  _ <- printsymIO (quote "NEWLINE")
  styled <- iterateIO (\() -> countPositioned tree)
  _ <- printsymIO (quote "End")
  _ <- printsymIO (quote "NEWLINE")
  _ <- printsymIO (quote "Running pass sumTextWidth (fold, uses=3): ")
  _ <- printsymIO (quote "NEWLINE")
  textW <- iterateIO (\() -> sumTextWidth tree)
  _ <- printsymIO (quote "End")
  _ <- printsymIO (quote "NEWLINE")
  _ <- printsymIO (quote "Running pass computeWidths (map, uses=14): ")
  _ <- printsymIO (quote "NEWLINE")
  tree' <- iterateIO (\() -> computeWidths tree_smaller)
  _ <- printsymIO (quote "End")
  _ <- printsymIO (quote "NEWLINE")
  _ <- printsymIO (quote "Running pass scaleLayout (map, uses=15): ")
  _ <- printsymIO (quote "NEWLINE")
