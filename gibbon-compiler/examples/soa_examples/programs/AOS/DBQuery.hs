...
gibbon_main =
            let _ = printsym (quote "Running Data base Query Pass: ")
                ...
                _ = printsym (quote "Running pass sumCost (fold): ")
                _ = printsym (quote "NEWLINE")
                totCost = iterate (sumCost queryTree)
                _ = printsym (quote "End")
                _ = printsym (quote "NEWLINE")
                _ = printsym (quote "Running pass sumRows (fold): ")
                _ = printsym (quote "NEWLINE")
                totRows = iterate (sumRows queryTree)
                _ = printsym (quote "End")
                _ = printsym (quote "NEWLINE")
                _ = printsym (quote "Running pass countJoins (fold): ")
                _ = printsym (quote "NEWLINE")
                totJoins = iterate (countJoins queryTree)
                _ = printsym (quote "End")
                _ = printsym (quote "NEWLINE")
                _ = printsym (quote "Running pass sumMemory (fold): ")
                _ = printsym (quote "NEWLINE")
                totMem = iterate (sumMemory queryTree)
                _ = printsym (quote "End")
                _ = printsym (quote "NEWLINE")
                _ = printsym (quote "Running pass scaleCosts (map): ")
                _ = printsym (quote "NEWLINE")
                queryTree' = iterate (scaleCosts queryTree 10)
                _ = printsym (quote "End")
                _ = printsym (quote "NEWLINE")
                _ = printsym (quote "Running pass clearQueryFlags (map): ")
                _ = printsym (quote "NEWLINE")
