...
gibbon_main =
            let _ = printsym (quote "Running Progam Piecewise Functions: ")
                ...
                pfTree = buildPW 20
                _ = printsym (quote "Running pass sum co-efficients (fold): ")
                _ = printsym (quote "NEWLINE")
                totCoeffs = iterate (sumCoeffs pfTree)
                _ = printsym (quote "End")
                _ = printsym (quote "NEWLINE")
                _ = printsym (quote "Running pass max degree (fold): ")
                _ = printsym (quote "NEWLINE")
                deg = iterate (maxDegree pfTree)
                _ = printsym (quote "End")
                _ = printsym (quote "NEWLINE")
                _ = printsym (quote "Running pass sumError (fold): ")
                _ = printsym (quote "NEWLINE")
                err = iterate (sumError pfTree)
                _ = printsym (quote "End")
                _ = printsym (quote "NEWLINE")
                _ = printsym (quote "Running pass countSplit (fold): ")
                _ = printsym (quote "NEWLINE")
                spltCount = iterate (countSplit pfTree 2)
                _ = printsym (quote "End")
                _ = printsym (quote "NEWLINE")
                _ = printsym (quote "Running pass square (map): ")
                _ = printsym (quote "NEWLINE")
                squarePfTree = iterate (squarePW pfTree)
                _ = printsym (quote "End")
                _ = printsym (quote "NEWLINE")
                _ = printsym (quote "Running pass add constant (map): ")
                _ = printsym (quote "NEWLINE")
