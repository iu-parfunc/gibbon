...
val _ = (case 
  let val wildcard__299_302_1265_1620 = (print "Running program Decision Tree: ") in 
  let val wildcard__297_303_1266_1621 = (print "NEWLINE") in 
  let val fltPrm_1565_1622 = 1 in 
  let val fltAppE_1564_1623 = (fltPrm_1565_1622 + 35) in 
  let val tree_304_1267_1624 = (buildTree fltAppE_1564_1623) in 
  let val wildcard__294_305_1268_1625 = (print "Running pass countNodes (fold, uses=2): ") in 
  let val wildcard__292_306_1269_1626 = (print "NEWLINE") in 
  let val nodes_307_1270_1627 = (countNodes tree_304_1267_1624) in 
  let val wildcard__288_308_1271_1628 = (print "End") in 
  let val wildcard__286_309_1272_1629 = (print "NEWLINE") in 
  let val wildcard__284_310_1273_1630 = (print "Running pass countLeaves (fold, uses=2): ") in 
  let val wildcard__282_311_1274_1631 = (print "NEWLINE") in 
  let val leaves_312_1275_1632 = (countLeaves tree_304_1267_1624) in 
  let val wildcard__278_313_1276_1633 = (print "End") in 
  let val wildcard__276_314_1277_1634 = (print "NEWLINE") in 
  let val wildcard__274_315_1278_1635 = (print "Running pass treeDepth (fold, uses=2): ") in 
  let val wildcard__272_316_1279_1636 = (print "NEWLINE") in 
  let val depth_317_1280_1637 = (treeDepth tree_304_1267_1624) in 
  let val wildcard__268_318_1281_1638 = (print "End") in 
  let val wildcard__266_319_1282_1639 = (print "NEWLINE") in 
  let val wildcard__264_320_1283_1640 = (print "Running pass sumImpurity (fold, uses=3): ") in 
  let val wildcard__262_321_1284_1641 = (print "NEWLINE") in 
  let val imp_322_1285_1642 = (sumImpurity tree_304_1267_1624) in 
  let val wildcard__258_323_1286_1643 = (print "End") in 
  let val wildcard__256_324_1287_1644 = (print "NEWLINE") in 
  let val wildcard__254_325_1288_1645 = (print "Running pass sumSamples (fold, uses=3): ") in 
  let val wildcard__252_326_1289_1646 = (print "NEWLINE") in 
  let val samples_327_1290_1647 = (sumSamples tree_304_1267_1624) in 
  let val wildcard__248_328_1291_1648 = (print "End") in 
  let val wildcard__246_329_1292_1649 = (print "NEWLINE") in 
  let val wildcard__244_330_1293_1650 = (print "Running pass countFeatureUses (fold, uses=3): ") in 
  let val wildcard__242_331_1294_1651 = (print "NEWLINE") in 
  let val feat0_332_1295_1652 = (countFeatureUses(0 , tree_304_1267_1624)) in 
  let val wildcard__238_333_1296_1653 = (print "End") in 
  let val wildcard__236_334_1297_1654 = (print "NEWLINE") in 
  let val wildcard__234_335_1298_1655 = (print "Running pass countSmallLeaves (fold, uses=3): ") in 
  let val wildcard__232_336_1299_1656 = (print "NEWLINE") in 
  let val small_337_1300_1657 = (countSmallLeaves(5 , tree_304_1267_1624)) in 
  let val wildcard__228_338_1301_1658 = (print "End") in 
  let val wildcard__226_339_1302_1659 = (print "NEWLINE") in 
  let val wildcard__224_340_1303_1660 = (print "Running pass inferenceCost (fold, uses=2): ") in 
  let val wildcard__222_341_1304_1661 = (print "NEWLINE") in 
  let val cost_342_1305_1662 = (inferenceCost tree_304_1267_1624) in 
  let val wildcard__218_343_1306_1663 = (print "End") in 
  let val wildcard__216_344_1307_1664 = (print "NEWLINE") in 
  let val wildcard__214_345_1308_1665 = (print "Running pass sumPathLengths (fold, uses=3): ") in 
  let val wildcard__212_346_1309_1666 = (print "NEWLINE") in 
  let val paths_347_1310_1667 = (sumPathLengths(0 , tree_304_1267_1624)) in 
  let val wildcard__208_348_1311_1668 = (print "End") in 
  let val wildcard__206_349_1312_1669 = (print "NEWLINE") in 
  let val fv_350_1313_1670 = (mkFeatureVec 32) in 
  let val wildcard__203_351_1314_1671 = (print "Running pass classify tree (fold, uses=5): ") in 
  let val wildcard__201_352_1315_1672 = (print "NEWLINE") in 
  let val pred_353_1316_1673 = (classify(tree_304_1267_1624 , fv_350_1313_1670)) in 
  let val wildcard__197_354_1317_1674 = (print "End") in 
  let val wildcard__195_355_1318_1675 = (print "NEWLINE") in 
  let val wildcard__193_356_1319_1676 = (print "Running pass classify Depth (fold, uses=4): ") in 
  let val wildcard__191_357_1320_1677 = (print "NEWLINE") in 
  let val pdepth_358_1321_1678 = (classifyDepth(tree_304_1267_1624 , fv_350_1313_1670, 0)) in 
  let val wildcard__187_359_1322_1679 = (print "End") in 
  let val wildcard__185_360_1323_1680 = (print "NEWLINE") in 
  let val wildcard__183_361_1324_1681 = (print "Running pass classify Batch (fold, uses=5): ") in 
  let val wildcard__181_362_1325_1682 = (print "NEWLINE") in 
  let val batch_363_1326_1683 = (classifyBatch(tree_304_1267_1624 , 32, 100)) in 
  let val wildcard__177_364_1327_1684 = (print "End") in 
  let val wildcard__175_365_1328_1685 = (print "NEWLINE") in (nodes_307_1270_1627 , leaves_312_1275_1632, depth_317_1280_1637, imp_322_1285_1642, samples_327_1290_1647, feat0_332_1295_1652, small_337_1300_1657, cost_342_1305_1662, paths_347_1310_1667, pred_353_1316_1673, pdepth_358_1321_1678, batch_363_1326_1683) end end end end end end end end end end end end end end end end end end end end end end end end end end end end end end end end end end end end end end end end end end end end end end end end end end end end end end end end end end end end end end end end end end of (x__1 , x__2, x__3, x__4, x__5, x__6, x__7, x__8, x__9, x__10, x__11, x__12) => let val _ = print "#(" val _ = (print(Int.toString(x__1))) val _ = print " "val _ = (print(Int.toString(x__2))) val _ = print " "val _ = (print(Int.toString(x__3))) val _ = print " "val _ = (print(Int.toString(x__4))) val _ = print " "val _ = (print(Int.toString(x__5))) val _ = print " "val _ = (print(Int.toString(x__6))) val _ = print " "val _ = (print(Int.toString(x__7))) val _ = print " "val _ = (print(Int.toString(x__8))) val _ = print " "val _ = (print(Int.toString(x__9))) val _ = print " "val _ = (print(Int.toString(x__10))) val _ = print " "val _ = (print(Int.toString(x__11))) val _ = print " "val _ = (print(Int.toString(x__12))) val _ = print ")" in () end);
val _ = print "\n"
