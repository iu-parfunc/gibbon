...
gibbon_main =
            let _ = printsym (quote "Running program OctTree Physics Simulation: ")
                ...
                _ = printsym (quote "Running pass sumMass (fold, uses=9): ")
                _ = printsym (quote "NEWLINE")
                totMass = iterate (sumMass octTree)
                _ = printsym (quote "End")
                _ = printsym (quote "NEWLINE")
                _ = printsym (quote "Running pass sumEnergy (fold, uses=10): ")
                _ = printsym (quote "NEWLINE")
                totEnergy = iterate (sumEnergy octTree)
                _ = printsym (quote "End")
                _ = printsym (quote "NEWLINE")
                _ = printsym (quote "Running pass countActive (fold, uses=9): ")
                _ = printsym (quote "NEWLINE")
