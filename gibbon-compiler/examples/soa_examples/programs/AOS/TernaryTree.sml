...
val _ = (print(Int.toString(
  let val wildcard__47_50_177_267 = (print "Running program Ternary Heap: ") in 
  let val wildcard__45_51_178_268 = (print "NEWLINE") in 
  let val tree_52_179_269 = (mkTree 15) in 
  let val wildcard__42_53_180_270 = (print "Running pass add 1 tree (map, uses=5): ") in 
  let val wildcard__40_54_181_271 = (print "NEWLINE") in 
  let val tree__55_182_272 = (add1Tree tree_52_179_269) in 
  let val wildcard__36_56_183_273 = (print "End") in 
  let val wildcard__34_57_184_274 = (print "NEWLINE") in 
  let val wildcard__32_58_185_275 = (print "Running pass sum tree (fold, uses=5): ") in 
  let val wildcard__30_59_186_276 = (print "NEWLINE") in 
  let val sum_60_187_277 = (sumTree tree__55_182_272) in 
  let val wildcard__26_61_188_278 = (print "End") in 
  let val wildcard__24_62_189_279 = (print "NEWLINE") in sum_60_187_277 end end end end end end end end end end end end end)));
val _ = print "\n"
