...
fun twoPointCorrelation (t_582_1244_1905 , qx_583_1245_1906, qy_584_1246_1907, qz_585_1247_1908, rLo_586_1248_1909, rHi_587_1249_1910) = (case t_582_1244_1905 of KDLeaf (x_588_1250_1911 , y_589_1251_1912, z_590_1252_1913, wildcard__168_591_1253_1914, wildcard__169_592_1254_1915) => 
  ...
  | KDEmpty => 0);
val _ = (case 
  let val wildcard__356_359_1021_1570 = (print "Running program KDTree: ") in 
  let val wildcard__354_360_1022_1571 = (print "NEWLINE") in 
  let val fltPrm_1433_1572 = 1 in 
  let val fltAppE_1432_1573 = (fltPrm_1433_1572 + 22) in 
  let val kdTree_361_1023_1574 = (buildKD(fltAppE_1432_1573 , 0)) in 
  let val wildcard__351_362_1024_1575 = (print "Running pass Find nearest Neighbour (fold_like, uses=13): ") in 
  let val wildcard__349_363_1025_1576 = (print "NEWLINE") in 
  let val dist_364_1026_1577 = (nearestDist(kdTree_361_1023_1574 , 1, 2, 3)) in 
  let val wildcard__345_365_1027_1578 = (print "End") in 
  let val wildcard__343_366_1028_1579 = (print "NEWLINE") in 
  let val wildcard__341_367_1029_1580 = (print "Running pass countInRange tight_box (fold_like, uses=13): ") in 
  let val wildcard__339_368_1030_1581 = (print "NEWLINE") in 
  let val inRangeCount_369_1031_1585 = 
  let val fltAppE_1434_1582 = (0 - 20) in 
  ...
  let val wildcard__335_370_1032_1586 = (print "End") in 
  let val wildcard__333_371_1033_1587 = (print "NEWLINE") in 
  let val wildcard__331_372_1034_1588 = (print "Running pass sumMassInRange (fold_like, uses=14): ") in 
  let val wildcard__329_373_1035_1589 = (print "NEWLINE") in 
  let val massInRange_374_1036_1593 = 
  let val fltAppE_1437_1590 = (0 - 25) in 
  ...
  let val wildcard__325_375_1037_1594 = (print "End") in 
  let val wildcard__323_376_1038_1595 = (print "NEWLINE") in 
  let val wildcard__321_377_1039_1596 = (print "Running pass twoPointCorrelation bin_8_16 (fold_like, uses=11): ") in 
  let val wildcard__319_378_1040_1597 = (print "NEWLINE") in 
  let val corrCount_379_1041_1598 = (twoPointCorrelation(kdTree_361_1023_1574 , 0, 0, 0, 8, 16)) in 
  let val wildcard__315_380_1042_1599 = (print "End") in 
  let val wildcard__313_381_1043_1600 = (print "NEWLINE") in 
  let val wildcard__311_382_1044_1601 = (print "Running pass pointCloudNeighborhood (fold_like, uses=11): ") in 
  let val wildcard__309_383_1045_1602 = (print "NEWLINE") in 
  let val cloudCount_384_1046_1603 = (pointCloudNeighborhood(kdTree_361_1023_1574 , 0, 0, 0, 24)) in 
  let val wildcard__305_385_1047_1604 = (print "End") in 
  let val wildcard__303_386_1048_1605 = (print "NEWLINE") in 
  let val wildcard__301_387_1049_1606 = (print "Running pass photonMappingBenchmark (fold_like, uses=12): ") in 
  let val wildcard__299_388_1050_1607 = (print "NEWLINE") in 
  let val photonHits_389_1051_1608 = (photonMappingBenchmark(kdTree_361_1023_1574 , 5, 16, 7, 18)) in 
  let val wildcard__295_390_1052_1609 = (print "End") in 
  let val wildcard__293_391_1053_1610 = (print "NEWLINE") in (dist_364_1026_1577 , inRangeCount_369_1031_1585, massInRange_374_1036_1593, corrCount_379_1041_1598, cloudCount_384_1046_1603, photonHits_389_1051_1608) end end end end end end end end end end end end end end end end end end end end end end end end end end end end end end end end end end end of (x__1 , x__2, x__3, x__4, x__5, x__6) => let val _ = print "#(" val _ = (print(Int.toString(x__1))) val _ = print " "val _ = (print(Int.toString(x__2))) val _ = print " "val _ = (print(Int.toString(x__3))) val _ = print " "val _ = (print(Int.toString(x__4))) val _ = print " "val _ = (print(Int.toString(x__5))) val _ = print " "val _ = (print(Int.toString(x__6))) val _ = print ")" in () end);
val _ = print "\n"
