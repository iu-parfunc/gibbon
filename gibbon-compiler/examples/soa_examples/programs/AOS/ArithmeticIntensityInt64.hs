-- ArithmeticIntensityInt64: Tree (Linear).
-- Functions: mkTree, arithKernel, checksumTree.
-- Annotated: MayVectorize on arithKernel.
...
mkTree d seed =
  if d <= 0
  then Leaf (toInt64 (mod seed 64 - 32))
...
gibbon_main =
  let _ = printsym (quote "Running program ArithmeticIntensity Int64: ")
      ...
      _ = printsym (quote "NEWLINE")
      cksum = iterate (checksumTree tree' (toInt64 0))
      _ = printsym (quote "End")
      _ = printsym (quote "NEWLINE")
  in cksum
