...
val _ = (print(Int.toString(
  let val wildcard__30_33_156_255 = (print "Running program recution on List with 10 Integer elements: ") in 
  let val wildcard__28_34_157_256 = (print "NEWLINE") in 
  let val lst_35_158_257 = (mkList 10000000) in 
  let val wildcard__25_36_159_258 = (print "Running pass reduction (fold, uses=2): ") in 
  let val wildcard__23_37_160_259 = (print "NEWLINE") in 
  let val sum_38_161_260 = (reduce lst_35_158_257) in 
  let val wildcard__19_39_162_261 = (print "End") in 
  let val wildcard__17_40_163_262 = (print "NEWLINE") in sum_38_161_260 end end end end end end end end)));
val _ = print "\n"
