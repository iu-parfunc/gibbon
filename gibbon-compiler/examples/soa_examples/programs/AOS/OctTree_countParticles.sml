...
val _ = (print(Int.toString(
  ...
  let val wildcard__8_19_1020_1526 = (print "Running pass countParticles (fold, uses=8): ") in 
  ...
  let val wildcard__0_23_1024_1530 = (print "NEWLINE") in totParticles_21_1022_1528 end end end end end end end end end end)));
val _ = print "\n"
