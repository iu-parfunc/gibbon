...
fun internal_copy_ColorOctree (arg_951_1148_1702) = (case arg_951_1148_1702 of CNode (x_952_1149_1703 , x_953_1150_1704, x_954_1151_1705, x_955_1152_1706, x_956_1153_1707, x_957_1154_1708, x_958_1155_1709, x_959_1156_1710, x_960_1157_1711, x_961_1158_1712, x_962_1159_1713, x_963_1160_1714, x_964_1161_1715, x_965_1162_1716, x_966_1163_1717, x_967_1164_1718, x_968_1165_1719, x_969_1166_1720, x_970_1167_1721, x_971_1168_1722, x_972_1169_1723, x_973_1170_1724) => 
  ...
  | CEmpty => CEmpty);
val _ = (case 
  let val wildcard__348_351_1135_1687 = (print "Running program ColorOctree Quantization: ") in 
  let val wildcard__346_352_1136_1688 = (print "NEWLINE") in 
  let val fltPrm_1531_1689 = 1 in 
  ...
  let val wildcard__343_354_1138_1692 = (print "Running pass paletteEntriesQuantized (fold, uses=13): ") in 
  let val wildcard__341_355_1139_1693 = (print "NEWLINE") in 
  let val paletteEntries_356_1140_1694 = (paletteEntriesQuantized(colorTree_353_1137_1691 , 4, 12)) in 
  let val wildcard__337_357_1141_1695 = (print "End") in 
  let val wildcard__335_358_1142_1696 = (print "NEWLINE") in 
  let val wildcard__333_359_1143_1697 = (print "Running pass quantizationErrorProxy (fold, uses=10): ") in 
  let val wildcard__331_360_1144_1698 = (print "NEWLINE") in 
  let val quantError_361_1145_1699 = (quantizationErrorProxy(colorTree_353_1137_1691 , 4, 11, 3)) in 
  let val wildcard__327_362_1146_1700 = (print "End") in 
  let val wildcard__325_363_1147_1701 = (print "NEWLINE") in (paletteEntries_356_1140_1694 , quantError_361_1145_1699) end end end end end end end end end end end end end end end of (x__1 , x__2) => let val _ = print "#(" val _ = (print(Int.toString(x__1))) val _ = print " "val _ = (print(Int.toString(x__2))) val _ = print ")" in () end);
val _ = print "\n"
