...
fun computeWidths (d_331_722_1031) = (case d_331_722_1031 of Elem (tag_332_723_1032 , cls_333_724_1033, style_334_725_1034, cost_335_726_1035, x_336_727_1036, y_337_728_1037, wildcard__119_338_729_1038, h_339_730_1039, l_340_731_1040, r_341_732_1041) => 
  ...
  | Empty => Empty);
val _ = (case 
  let val wildcard__256_259_650_947 = (print "Running program DomTree: ") in 
  let val wildcard__254_260_651_948 = (print "NEWLINE") in 
  let val tree_261_652_949 = (buildRenderTree 23) in 
  let val tree_smaller_262_653_950 = (buildRenderTree 20) in 
  let val wildcard__250_263_654_951 = (print "Running pass SumArea (fold, uses=6): ") in 
  let val wildcard__248_264_655_952 = (print "NEWLINE") in 
  let val area_265_656_953 = (sumArea tree_261_652_949) in 
  let val wildcard__244_266_657_954 = (print "End") in 
  let val wildcard__242_267_658_955 = (print "NEWLINE") in 
  let val wildcard__240_268_659_956 = (print "Running pass find max Bottom (fold, uses=5): ") in 
  let val wildcard__238_269_660_957 = (print "NEWLINE") in 
  let val bottom_270_661_958 = (maxBottom tree_261_652_949) in 
  let val wildcard__234_271_662_959 = (print "End") in 
  let val wildcard__232_272_663_960 = (print "NEWLINE") in 
  let val wildcard__230_273_664_961 = (print "Running pass count styled (fold, uses=3): ") in 
  let val wildcard__228_274_665_962 = (print "NEWLINE") in 
  let val styled_275_666_963 = (countPositioned tree_261_652_949) in 
  let val wildcard__224_276_667_964 = (print "End") in 
  let val wildcard__222_277_668_965 = (print "NEWLINE") in 
  let val wildcard__220_278_669_966 = (print "Running pass sumTextWidth (fold, uses=3): ") in 
  let val wildcard__218_279_670_967 = (print "NEWLINE") in 
  let val textW_280_671_968 = (sumTextWidth tree_261_652_949) in 
  let val wildcard__214_281_672_969 = (print "End") in 
  let val wildcard__212_282_673_970 = (print "NEWLINE") in 
  let val wildcard__210_283_674_971 = (print "Running pass computeWidths (map, uses=14): ") in 
  let val wildcard__208_284_675_972 = (print "NEWLINE") in 
  let val tree__285_676_973 = (computeWidths tree_smaller_262_653_950) in 
  let val wildcard__204_286_677_974 = (print "End") in 
  let val wildcard__202_287_678_975 = (print "NEWLINE") in 
  let val wildcard__200_288_679_976 = (print "Running pass scaleLayout (map, uses=15): ") in 
  let val wildcard__198_289_680_977 = (print "NEWLINE") in 
  let val tree___290_681_978 = (scaleLayout(tree__285_676_973 , 2)) in 
  let val wildcard__194_291_682_979 = (print "End") in 
  let val wildcard__192_292_683_980 = (print "NEWLINE") in 
