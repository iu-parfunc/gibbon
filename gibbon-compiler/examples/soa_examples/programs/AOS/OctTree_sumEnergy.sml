...
val _ = (print(Int.toString(
  let val wildcard__13_16_1017_1532 = (print "Running program OctTree Physics Simulation: ") in 
  let val wildcard__11_17_1018_1533 = (print "NEWLINE") in 
  ...
  let val wildcard__8_19_1020_1537 = (print "Running pass sumEnergy (fold, uses=12): ") in 
  let val wildcard__6_20_1021_1538 = (print "NEWLINE") in 
  let val totEnergy_21_1022_1539 = (sumEnergy octTree_18_1019_1536) in 
  let val wildcard__2_22_1023_1540 = (print "End") in 
  let val wildcard__0_23_1024_1541 = (print "NEWLINE") in totEnergy_21_1022_1539 end end end end end end end end end end)));
val _ = print "\n"
