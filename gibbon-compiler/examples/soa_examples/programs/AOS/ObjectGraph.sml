...
fun liveBytes (h_273_612_832) = (case h_273_612_832 of Obj (wildcard__36_274_613_833 , size_275_614_834, mark_276_615_835, l_277_616_836, r_278_617_837) => 
  ...
  | Null => 0);
val _ = (case 
  let val wildcard__214_217_556_780 = (print "Running program ObjectGraph Simulated a GC Program: ") in 
  let val wildcard__212_218_557_781 = (print "NEWLINE") in 
  let val fltPrm_741_782 = 1 in 
  let val fltAppE_740_783 = (fltPrm_741_782 + 23) in 
  let val heap_219_558_784 = (buildHeap fltAppE_740_783) in 
  let val wildcard__209_220_559_785 = (print "Running pass totalHeapSize (fold, uses=3): ") in 
  let val wildcard__207_221_560_786 = (print "NEWLINE") in 
  let val heapSize_222_561_787 = (totalHeapSize heap_219_558_784) in 
  let val wildcard__203_223_562_788 = (print "End") in 
  let val wildcard__201_224_563_789 = (print "NEWLINE") in 
  let val wildcard__199_225_564_790 = (print "Running pass countMarked (fold, uses=3): ") in 
  let val wildcard__197_226_565_791 = (print "NEWLINE") in 
  let val countMarkedItems_227_566_792 = (countMarked heap_219_558_784) in 
  let val wildcard__193_228_567_793 = (print "End") in 
  let val wildcard__191_229_568_794 = (print "NEWLINE") in 
  let val wildcard__189_230_569_795 = (print "Running pass countLargeItems (fold, uses=3): ") in 
  let val wildcard__187_231_570_796 = (print "NEWLINE") in 
  let val countLargeItems_232_571_797 = (countLarge(heap_219_558_784 , 100)) in 
  let val wildcard__183_233_572_798 = (print "End") in 
  let val wildcard__181_234_573_799 = (print "NEWLINE") in 
  let val wildcard__179_235_574_800 = (print "Running pass liveBytes (fold, uses=4): ") in 
  let val wildcard__177_236_575_801 = (print "NEWLINE") in 
  let val liveSet_237_576_802 = (liveBytes heap_219_558_784) in 
  let val wildcard__173_238_577_803 = (print "End") in 
  let val wildcard__171_239_578_804 = (print "NEWLINE") in 
  let val wildcard__169_240_579_805 = (print "Running pass deadBytes (fold, uses=4): ") in 
  let val wildcard__167_241_580_806 = (print "NEWLINE") in 
  let val reclaimable_242_581_807 = (deadBytes heap_219_558_784) in 
  let val wildcard__163_243_582_808 = (print "End") in 
  let val wildcard__161_244_583_809 = (print "NEWLINE") in 
  let val wildcard__159_245_584_810 = (print "Running pass countSurvivors (fold, uses=4): ") in 
  let val wildcard__157_246_585_811 = (print "NEWLINE") in 
  let val survivors_247_586_812 = (countSurvivors(heap_219_558_784 , 120)) in 
  let val wildcard__153_248_587_813 = (print "End") in 
  let val wildcard__151_249_588_814 = (print "NEWLINE") in 
  let val wildcard__149_250_589_815 = (print "Running pass sumObjIds (fold, uses=3): ") in 
  let val wildcard__147_251_590_816 = (print "NEWLINE") in 
  let val sObjIds_252_591_817 = (sumObjIds heap_219_558_784) in 
  let val wildcard__143_253_592_818 = (print "End") in 
  let val wildcard__141_254_593_819 = (print "NEWLINE") in 
  let val wildcard__139_255_594_820 = (print "Running pass sweepUnmarked (map, uses=5): ") in 
  let val wildcard__137_256_595_821 = (print "NEWLINE") in 
  let val heapSwept_257_596_822 = (sweepUnmarked heap_219_558_784) in 
  let val wildcard__133_258_597_823 = (print "End") in 
  let val wildcard__131_259_598_824 = (print "NEWLINE") in 
  let val wildcard__129_260_599_825 = (print "Running pass touchHotObjects (map, uses=5): ") in 
  let val wildcard__127_261_600_826 = (print "NEWLINE") in 
  let val heapHot_262_601_827 = (touchHotObjects(heap_219_558_784 , 4, 12)) in 
  let val wildcard__123_263_602_828 = (print "End") in 
  let val wildcard__121_264_603_829 = (print "NEWLINE") in 
