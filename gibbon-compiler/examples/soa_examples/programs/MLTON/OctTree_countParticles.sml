...
fun internal_traverse_Octree (arg_929_1229_1695) = (case arg_929_1229_1695 of Cell (x_930_1230_1696 , x_931_1231_1697, x_932_1232_1698, x_933_1233_1699, x_934_1234_1700, x_935_1235_1701, x_936_1236_1702, x_937_1237_1703, x_938_1238_1704, x_939_1239_1705, x_940_1240_1706, x_941_1241_1707, x_942_1242_1708) => 
  let val y_948_1243_1709 = (internal_traverse_Octree x_935_1235_1701) in 
  let val y_949_1244_1710 = (internal_traverse_Octree x_936_1236_1702) in 
  let val y_950_1245_1711 = (internal_traverse_Octree x_937_1237_1703) in 
  let val y_951_1246_1712 = (internal_traverse_Octree x_938_1238_1704) in 
  let val y_952_1247_1713 = (internal_traverse_Octree x_939_1239_1705) in 
  let val y_953_1248_1714 = (internal_traverse_Octree x_940_1240_1706) in 
  let val y_954_1249_1715 = (internal_traverse_Octree x_941_1241_1707) in 
  let val y_955_1250_1716 = (internal_traverse_Octree x_942_1242_1708) in () end end end end end end end end 
  | Particle (x_956_1251_1717 , x_957_1252_1718, x_958_1253_1719) => ()
  | EmptyOct => ());

fun internal_print_Octree (arg_962_1174_1640) = (case arg_962_1174_1640 of Cell (x_963_1175_1641 , x_964_1176_1642, x_965_1177_1643, x_966_1178_1644, x_967_1179_1645, x_968_1180_1646, x_969_1181_1647, x_970_1182_1648, x_971_1183_1649, x_972_1184_1650, x_973_1185_1651, x_974_1186_1652, x_975_1187_1653) => 
  let val wildcard_989_1188_1654 = (print "(Cell") in 
  let val wildcard_1003_1189_1655 = (print " ") in 
  let val y_976_1190_1656 = (print(Int.toString(x_963_1175_1641))) in 
  let val wildcard_1002_1191_1657 = (print " ") in 
  let val y_977_1192_1658 = (print(Int.toString(x_964_1176_1642))) in 
  let val wildcard_1001_1193_1659 = (print " ") in 
  let val y_978_1194_1660 = (print(Int.toString(x_965_1177_1643))) in 
  let val wildcard_1000_1195_1661 = (print " ") in 
  let val y_979_1196_1662 = (print(Int.toString(x_966_1178_1644))) in 
  let val wildcard_999_1197_1663 = (print " ") in 
  let val y_980_1198_1664 = (print(Int.toString(x_967_1179_1645))) in 
  let val wildcard_998_1199_1665 = (print " ") in 
  let val y_981_1200_1666 = (internal_print_Octree x_968_1180_1646) in 
  let val wildcard_997_1201_1667 = (print " ") in 
  let val y_982_1202_1668 = (internal_print_Octree x_969_1181_1647) in 
  let val wildcard_996_1203_1669 = (print " ") in 
  let val y_983_1204_1670 = (internal_print_Octree x_970_1182_1648) in 
  let val wildcard_995_1205_1671 = (print " ") in 
  let val y_984_1206_1672 = (internal_print_Octree x_971_1183_1649) in 
  let val wildcard_994_1207_1673 = (print " ") in 
  let val y_985_1208_1674 = (internal_print_Octree x_972_1184_1650) in 
  let val wildcard_993_1209_1675 = (print " ") in 
  let val y_986_1210_1676 = (internal_print_Octree x_973_1185_1651) in 
  let val wildcard_992_1211_1677 = (print " ") in 
  let val y_987_1212_1678 = (internal_print_Octree x_974_1186_1652) in 
  let val wildcard_991_1213_1679 = (print " ") in 
  let val y_988_1214_1680 = (internal_print_Octree x_975_1187_1653) in 
  let val wildcard_990_1215_1681 = (print ")") in () end end end end end end end end end end end end end end end end end end end end end end end end end end end end 
  | Particle (x_1004_1216_1682 , x_1005_1217_1683, x_1006_1218_1684) => 
  let val wildcard_1010_1219_1685 = (print "(Particle") in 
  let val wildcard_1014_1220_1686 = (print " ") in 
  let val y_1007_1221_1687 = (print(Int.toString(x_1004_1216_1682))) in 
  let val wildcard_1013_1222_1688 = (print " ") in 
  let val y_1008_1223_1689 = (print(Int.toString(x_1005_1217_1683))) in 
  let val wildcard_1012_1224_1690 = (print " ") in 
  let val y_1009_1225_1691 = (print(Int.toString(x_1006_1218_1684))) in 
  let val wildcard_1011_1226_1692 = (print ")") in () end end end end end end end end
  | EmptyOct => 
  let val wildcard_1015_1227_1693 = (print "(EmptyOct") in 
  let val wildcard_1016_1228_1694 = (print ")") in () end end);

fun massOf (t_123_1157_1623) = (case t_123_1157_1623 of Cell (m_124_1158_1624 , wildcard__14_125_1159_1625, wildcard__15_126_1160_1626, wildcard__16_127_1161_1627, wildcard__17_128_1162_1628, wildcard__18_129_1163_1629, wildcard__19_130_1164_1630, wildcard__20_131_1165_1631, wildcard__21_132_1166_1632, wildcard__22_133_1167_1633, wildcard__23_134_1168_1634, wildcard__24_135_1169_1635, wildcard__25_136_1170_1636) => m_124_1158_1624 
  | Particle (m_137_1171_1637 , wildcard__39_138_1172_1638, wildcard__40_139_1173_1639) => m_137_1171_1637
  | EmptyOct => 0);

fun weightedPos (t_106_1140_1606) = (case t_106_1140_1606 of Cell (m_107_1141_1607 , c_108_1142_1608, wildcard__45_109_1143_1609, wildcard__46_110_1144_1610, wildcard__47_111_1145_1611, wildcard__48_112_1146_1612, wildcard__49_113_1147_1613, wildcard__50_114_1148_1614, wildcard__51_115_1149_1615, wildcard__52_116_1150_1616, wildcard__53_117_1151_1617, wildcard__54_118_1152_1618, wildcard__55_119_1153_1619) => (m_107_1141_1607 * c_108_1142_1608) 
  | Particle (m_120_1154_1620 , p_121_1155_1621, wildcard__69_122_1156_1622) => (m_120_1154_1620 * p_121_1155_1621)
  | EmptyOct => 0);

fun countParticles (t_61_1095_1581) = (case t_61_1095_1581 of Particle (wildcard__251_62_1096_1582 , wildcard__252_63_1097_1583, wildcard__253_64_1098_1584) => 1 
  | Cell (wildcard__257_65_1099_1585 , wildcard__258_66_1100_1586, wildcard__259_67_1101_1587, wildcard__260_68_1102_1588, wildcard__261_69_1103_1589, a_70_1104_1590, b_71_1105_1591, c_72_1106_1592, d_73_1107_1593, e_74_1108_1594, f_75_1109_1595, g_76_1110_1596, h_77_1111_1597) => 
  let val fltAppE_1440_1598 = (countParticles a_70_1104_1590) in 
  let val fltAppE_1441_1599 = (countParticles b_71_1105_1591) in 
  let val fltAppE_1442_1600 = (countParticles c_72_1106_1592) in 
  let val fltAppE_1443_1601 = (countParticles d_73_1107_1593) in 
  let val fltAppE_1444_1602 = (countParticles e_74_1108_1594) in 
  let val fltAppE_1445_1603 = (countParticles f_75_1109_1595) in 
  let val fltAppE_1446_1604 = (countParticles g_76_1110_1596) in 
  let val fltAppE_1447_1605 = (countParticles h_77_1111_1597) in (sum8(fltAppE_1440_1598 , fltAppE_1441_1599, fltAppE_1442_1600, fltAppE_1443_1601, fltAppE_1444_1602, fltAppE_1445_1603, fltAppE_1446_1604, fltAppE_1447_1605)) end end end end end end end end
  | EmptyOct => 0);
...
val _ = (print(Int.toString(
  let val wildcard__13_16_1017_1521 = (printsym "Running program OctTree Physics Simulation: ") in 
  let val wildcard__11_17_1018_1522 = (printsym "NEWLINE") in 
  ...
  let val wildcard__8_19_1020_1526 = (printsym "Running pass countParticles (fold, uses=8): ") in 
  let val wildcard__6_20_1021_1527 = (printsym "NEWLINE") in 
  let val totParticles_21_1022_1528 = (countParticles octTree_18_1019_1525) in 
  let val wildcard__2_22_1023_1529 = (printsym "End") in 
  let val wildcard__0_23_1024_1530 = (printsym "NEWLINE") in totParticles_21_1022_1528 end end end end end end end end end end)));
val _ = print "\n"
