...
val _ = (case 
  let val wildcard__65_68_170_236 = (printsym "Running program List: ") in 
  let val wildcard__63_69_171_237 = (printsym "NEWLINE") in 
  let val lst_70_172_238 = (mkList 100000000) in 
  let val wildcard__60_71_173_239 = (printsym "Running pass add1 List (map, uses=2): ") in 
  let val wildcard__58_72_174_240 = (printsym "NEWLINE") in 
  let val lst__73_175_241 = (iterate (fn () => add1 lst_70_172_238)) in 
  let val wildcard__54_74_176_242 = (printsym "End") in 
  let val wildcard__52_75_177_243 = (printsym "NEWLINE") in 
  let val wildcard__50_76_178_244 = (printsym "Running pass length List (fold, uses=1): ") in 
  let val wildcard__48_77_179_245 = (printsym "NEWLINE") in 
  let val len_78_180_246 = (iterate (fn () => length lst_70_172_238)) in 
  let val wildcard__44_79_181_247 = (printsym "End") in 
  let val wildcard__42_80_182_248 = (printsym "NEWLINE") in 
  let val wildcard__40_81_183_249 = (printsym "Running pass sumList (fold, uses=2): ") in 
  let val wildcard__38_82_184_250 = (printsym "NEWLINE") in 
  let val sum_83_185_251 = (iterate (fn () => sumList lst__73_175_241)) in 
  let val wildcard__34_84_186_252 = (printsym "End") in 
  let val wildcard__32_85_187_253 = (printsym "NEWLINE") in 
  let val wildcard__30_86_188_254 = (printsym "Running pass sumList tail recursive (fold, uses=2): ") in 
  let val wildcard__28_87_189_255 = (printsym "NEWLINE") in 
  let val sum__88_190_256 = (iterate (fn () => sumListAcc(lst__73_175_241 , 0))) in 
  let val wildcard__24_89_191_257 = (printsym "End") in 
  let val wildcard__22_90_192_258 = (printsym "NEWLINE") in (sum_83_185_251 , sum__88_190_256, len_78_180_246) end end end end end end end end end end end end end end end end end end end end end end end of (x__1 , x__2, x__3) => let val _ = print "#(" val _ = (print(Int.toString(x__1))) val _ = print " "val _ = (print(Int.toString(x__2))) val _ = print " "val _ = (print(Int.toString(x__3))) val _ = print ")" in () end);
val _ = print "\n"
