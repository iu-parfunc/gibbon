...
val _ = (print(Int.toString(
  let val wildcard__14_17_1023_1538 = (printsym "Running program OctTree Physics Simulation: ") in 
  let val wildcard__12_18_1024_1539 = (printsym "NEWLINE") in 
  let val octTree_19_1025_1540 = (buildOctree(8 , 17, 0, 64)) in 
  let val wildcard__9_20_1026_1541 = (printsym "Running pass clearFlags (map, uses=15): ") in 
  let val wildcard__7_21_1027_1542 = (printsym "NEWLINE") in 
  ...
  let val wildcard__2_24_1030_1545 = (printsym "End") in 
  let val wildcard__0_25_1031_1546 = (printsym "NEWLINE") in active_23_1029_1544 end end end end end end end end end)));
val _ = print "\n"
