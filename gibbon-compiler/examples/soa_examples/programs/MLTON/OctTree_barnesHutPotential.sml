...
val _ = (print(Int.toString(
  let val wildcard__13_16_1017_1531 = (printsym "Running program OctTree Physics Simulation: ") in 
  let val wildcard__11_17_1018_1532 = (printsym "NEWLINE") in 
  ...
  let val wildcard__8_19_1020_1536 = (printsym "Running pass barnesHutPotential (fold_like, uses=11): ") in 
  let val wildcard__6_20_1021_1537 = (printsym "NEWLINE") in 
  let val bhPotential_21_1022_1538 = (barnesHutPotential(octTree_18_1019_1535 , 21, 60)) in 
  let val wildcard__2_22_1023_1539 = (printsym "End") in 
  let val wildcard__0_23_1024_1540 = (printsym "NEWLINE") in bhPotential_21_1022_1538 end end end end end end end end end end)));
val _ = print "\n"
