...
val _ = (case 
  let val wildcard__54_57_168_242 = (printsym "Running program MonoTree: ") in 
  let val wildcard__52_58_169_243 = (printsym "NEWLINE") in 
  let val tree_59_170_244 = (mkTree(23 , 0)) in 
  let val wildcard__49_60_171_245 = (printsym "Running pass add1Tree (map, uses=3): ") in 
  let val wildcard__47_61_172_246 = (printsym "NEWLINE") in 
  let val tree__62_173_247 = (iterate (fn () => add1Tree tree_59_170_244)) in 
  let val wildcard__43_63_174_248 = (printsym "End") in 
  let val wildcard__41_64_175_249 = (printsym "NEWLINE") in 
  let val wildcard__39_65_176_250 = (printsym "Running pass sumTree (fold, uses=3): ") in 
  let val wildcard__37_66_177_251 = (printsym "NEWLINE") in 
  let val val_67_178_252 = (iterate (fn () => sumTree tree__62_173_247)) in 
  let val wildcard__33_68_179_253 = (printsym "End") in 
  let val wildcard__31_69_180_254 = (printsym "NEWLINE") in 
  let val wildcard__29_70_181_255 = (printsym "Running pass sumTree TailRec (fold, uses=3): ") in 
  let val wildcard__27_71_182_256 = (printsym "NEWLINE") in 
  let val val__72_183_257 = (iterate (fn () => sumTreeAcc(tree__62_173_247 , 0))) in 
  let val wildcard__23_73_184_258 = (printsym "End") in 
  let val wildcard__21_74_185_259 = (printsym "NEWLINE") in (val_67_178_252 , val__72_183_257) end end end end end end end end end end end end end end end end end end of (x__1 , x__2) => let val _ = print "#(" val _ = (print(Int.toString(x__1))) val _ = print " "val _ = (print(Int.toString(x__2))) val _ = print ")" in () end);
val _ = print "\n"
