...
fun sumEnergy (t_522_1596_2251) = (case t_522_1596_2251 of Cell (m_523_1597_2252 , c_524_1598_2253, wildcard__200_525_1599_2254, s_526_1600_2255, mom_527_1601_2256, a_528_1602_2257, b_529_1603_2258, c1_530_1604_2259, d_531_1605_2260, e_532_1606_2261, f_533_1607_2262, g_534_1608_2263, h_535_1609_2264) => 
  ...
  | EmptyOct => 0);
val _ = (case 
  let val wildcard__474_477_1551_2204 = (printsym "Running program OctTree Physics Simulation: ") in 
  let val wildcard__472_478_1552_2205 = (printsym "NEWLINE") in 
  let val fltPrm_2010_2206 = (GibbonCompat.getSizeParam()) in 
  let val fltAppE_2009_2207 = (fltPrm_2010_2206 + 7) in 
  let val octTree_479_1553_2208 = (buildOctree(fltAppE_2009_2207 , 17, 0, 64)) in 
  let val wildcard__469_480_1554_2209 = (printsym "Running pass sumMass (fold, uses=10): ") in 
  let val wildcard__467_481_1555_2210 = (printsym "NEWLINE") in 
  let val totMass_482_1556_2211 = (iterate (fn () => sumMass octTree_479_1553_2208)) in 
  let val wildcard__463_483_1557_2212 = (printsym "End") in 
  let val wildcard__461_484_1558_2213 = (printsym "NEWLINE") in 
  let val wildcard__459_485_1559_2214 = (printsym "Running pass sumEnergy (fold, uses=12): ") in 
  let val wildcard__457_486_1560_2215 = (printsym "NEWLINE") in 
  let val totEnergy_487_1561_2216 = (iterate (fn () => sumEnergy octTree_479_1553_2208)) in 
  let val wildcard__453_488_1562_2217 = (printsym "End") in 
  let val wildcard__451_489_1563_2218 = (printsym "NEWLINE") in 
  let val wildcard__449_490_1564_2219 = (printsym "Running pass countActive (fold, uses=10): ") in 
  let val wildcard__447_491_1565_2220 = (printsym "NEWLINE") in 
  let val totActive_492_1566_2221 = (iterate (fn () => countActive(octTree_479_1553_2208 , 60))) in 
  let val wildcard__443_493_1567_2222 = (printsym "End") in 
  let val wildcard__441_494_1568_2223 = (printsym "NEWLINE") in 
  let val wildcard__439_495_1569_2224 = (printsym "Running pass countParticles (fold, uses=8): ") in 
  let val wildcard__437_496_1570_2225 = (printsym "NEWLINE") in 
  let val totParticles_497_1571_2226 = (iterate (fn () => countParticles octTree_479_1553_2208)) in 
  let val wildcard__433_498_1572_2227 = (printsym "End") in 
  let val wildcard__431_499_1573_2228 = (printsym "NEWLINE") in 
  let val wildcard__429_500_1574_2229 = (printsym "Running pass barnesHutPotential (fold_like, uses=11): ") in 
  let val wildcard__427_501_1575_2230 = (printsym "NEWLINE") in 
  let val bhPotential_502_1576_2231 = (iterate (fn () => barnesHutPotential(octTree_479_1553_2208 , 21, 60))) in 
  let val wildcard__423_503_1577_2232 = (printsym "End") in 
  let val wildcard__421_504_1578_2233 = (printsym "NEWLINE") in 
  let val wildcard__419_505_1579_2234 = (printsym "Running pass fmmPotential (fold_like, uses=12): ") in 
  let val wildcard__417_506_1580_2235 = (printsym "NEWLINE") in 
  let val fmmPot_507_1581_2236 = (iterate (fn () => fmmPotential(octTree_479_1553_2208 , 21, 4, 70))) in 
  let val wildcard__413_508_1582_2237 = (printsym "End") in 
  let val wildcard__411_509_1583_2238 = (printsym "NEWLINE") in 
  let val wildcard__409_510_1584_2239 = (printsym "Running pass scaleEnergy (map, uses=16): ") in 
  let val wildcard__407_511_1585_2240 = (printsym "NEWLINE") in 
  let val octTree__512_1586_2241 = (iterate (fn () => scaleEnergy(octTree_479_1553_2208 , 9))) in 
  let val wildcard__403_513_1587_2242 = (printsym "End") in 
  let val wildcard__401_514_1588_2243 = (printsym "NEWLINE") in 
  let val wildcard__399_515_1589_2244 = (printsym "Running pass clearFlags (map, uses=15): ") in 
  let val wildcard__397_516_1590_2245 = (printsym "NEWLINE") in 
