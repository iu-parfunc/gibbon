...
fun mixSeed (s_449_1069_1496 , salt_450_1070_1497) = 
  let val fltPrm_1241_1498 = (s_449_1069_1496 * 1103) in 
  let val fltPrm_1242_1499 = (salt_450_1070_1497 * 97) in 
  let val fltPrm_1240_1500 = (fltPrm_1241_1498 + fltPrm_1242_1499) in (fltPrm_1240_1500 + 13) end end end;
...
fun sumRows (q_399_988_1403) = (case q_399_988_1403 of Join (wildcard__57_400_989_1404 , r_401_990_1405, wildcard__58_402_991_1406, wildcard__59_403_992_1407, l_404_993_1408, s_405_994_1409) => 
  ...
  let val fltPrm_1232_1419 = (childRows_411_1000_1418 * sel_407_996_1414) in 
...
val _ = (case 
  ...
  let val fltAppE_1218_1317 = (fltPrm_1219_1316 + 75) in 
  let val queryTree_322_911_1318 = (buildQuery(fltAppE_1218_1317 , 17)) in 
  let val wildcard__312_323_912_1319 = (printsym "Running pass sumCost (fold, uses=6): ") in 
  let val wildcard__310_324_913_1320 = (printsym "NEWLINE") in 
  let val totCost_325_914_1321 = (iterate (fn () => sumCost queryTree_322_911_1318)) in 
  let val wildcard__306_326_915_1322 = (printsym "End") in 
  let val wildcard__304_327_916_1323 = (printsym "NEWLINE") in 
  let val wildcard__302_328_917_1324 = (printsym "Running pass sumRows (fold, uses=6): ") in 
  let val wildcard__300_329_918_1325 = (printsym "NEWLINE") in 
  let val totRows_330_919_1326 = (iterate (fn () => sumRows queryTree_322_911_1318)) in 
  let val wildcard__296_331_920_1327 = (printsym "End") in 
  let val wildcard__294_332_921_1328 = (printsym "NEWLINE") in 
  let val wildcard__292_333_922_1329 = (printsym "Running pass countJoins (fold, uses=3): ") in 
  let val wildcard__290_334_923_1330 = (printsym "NEWLINE") in 
  let val totJoins_335_924_1331 = (iterate (fn () => countJoins queryTree_322_911_1318)) in 
  let val wildcard__286_336_925_1332 = (printsym "End") in 
  let val wildcard__284_337_926_1333 = (printsym "NEWLINE") in 
  let val wildcard__282_338_927_1334 = (printsym "Running pass sumMemory (fold, uses=6): ") in 
  let val wildcard__280_339_928_1335 = (printsym "NEWLINE") in 
  let val totMem_340_929_1336 = (iterate (fn () => sumMemory queryTree_322_911_1318)) in 
  let val wildcard__276_341_930_1337 = (printsym "End") in 
  let val wildcard__274_342_931_1338 = (printsym "NEWLINE") in 
  let val wildcard__272_343_932_1339 = (printsym "Running pass hashJoinPressure (fold, uses=5): ") in 
  let val wildcard__270_344_933_1340 = (printsym "NEWLINE") in 
  let val hashPressure_345_934_1341 = (iterate (fn () => hashJoinPressure queryTree_322_911_1318)) in 
  let val wildcard__266_346_935_1342 = (printsym "End") in 
  let val wildcard__264_347_936_1343 = (printsym "NEWLINE") in 
  let val wildcard__262_348_937_1344 = (printsym "Running pass filterSelectivitySkew (fold, uses=5): ") in 
  let val wildcard__260_349_938_1345 = (printsym "NEWLINE") in 
  let val selSkew_350_939_1346 = (iterate (fn () => filterSelectivitySkew queryTree_322_911_1318)) in 
  let val wildcard__256_351_940_1347 = (printsym "End") in 
  let val wildcard__254_352_941_1348 = (printsym "NEWLINE") in 
  let val wildcard__252_353_942_1349 = (printsym "Running pass scaleCosts (map, uses=15): ") in 
  let val wildcard__250_354_943_1350 = (printsym "NEWLINE") in 
  let val queryTree__355_944_1351 = (iterate (fn () => scaleCosts(queryTree_322_911_1318 , 10))) in 
  let val wildcard__246_356_945_1352 = (printsym "End") in 
  let val wildcard__244_357_946_1353 = (printsym "NEWLINE") in 
  let val wildcard__242_358_947_1354 = (printsym "Running pass clearQueryFlags (map, uses=14): ") in 
  let val wildcard__240_359_948_1355 = (printsym "NEWLINE") in 
  let val queryTree___360_949_1356 = (iterate (fn () => clearQueryFlags queryTree__355_944_1351)) in 
  let val wildcard__236_361_950_1357 = (printsym "End") in 
