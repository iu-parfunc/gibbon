...
gibbon_main =
            let _ = printsym (quote "Running program ObjectGraph Simulated a GC Program: ")
                ...
                heap = buildHeap 20
                _ = printsym (quote "Running pass totalHeapSize (fold): ")
                _ = printsym (quote "NEWLINE")
                heapSize = iterate (totalHeapSize heap)
                _ = printsym (quote "End")
                _ = printsym (quote "NEWLINE")
                _ = printsym (quote "Running pass countMarked (fold): ")
                _ = printsym (quote "NEWLINE")
                countMarkedItems = iterate (countMarked heap)
                _ = printsym (quote "End")
                _ = printsym (quote "NEWLINE")
                _ = printsym (quote "Running pass countLargeItems (fold): ")
                _ = printsym (quote "NEWLINE")
                countLargeItems = iterate (countLarge heap 100)
                _ = printsym (quote "End")
                _ = printsym (quote "NEWLINE")
                _ = printsym (quote "Running pass sumObjIds (fold): ")
                _ = printsym (quote "NEWLINE")
                sObjIds = iterate (sumObjIds heap)
                _ = printsym (quote "End")
                _ = printsym (quote "NEWLINE")
                _ = printsym (quote "Running pass clearMarks (map): ")
                _ = printsym (quote "NEWLINE")
                heap' = iterate (clearMarks heap)
                _ = printsym (quote "End")
                _ = printsym (quote "NEWLINE")
                _ = printsym (quote "Running pass inflateSizes (map): ")
                _ = printsym (quote "NEWLINE")
