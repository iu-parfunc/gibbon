...
GibInt do_reverse_and_sumlist(GibInt n_19_183_289);
...
void info_table_initialize(void)
{
    ...
    error = gib_info_table_insert_packed_dcon(List_T, 0, 0, 0, 0, 0, field_tys, 0);
    if (error < 0) {
        fprintf(stderr,
                "Couldn't insert into info table, errorno=%d, tycon=%d, dcon=%d",
                error, List_T, 0);
...
GibInt do_reverse_and_sumlist(GibInt n_19_183_289)
{
    ...
    *(GibBoxedTag *) r_720 = 0;
    ...
    volatile GibCursorGibCursorGibCursorGibCursorProd tmp_struct_17;
    volatile GibCursorGibIntProd tmp_struct_18;
    ...
    for (int i = 0; i < N; i++) {
        ...
        clock_gettime(CLOCK_MONOTONIC_RAW, &begin);
        tmp_struct_17 = reverse(pvrtmp_1384, end_r_720, end_r_719, r_719, pvrtmp_1385, r_720);
        tmp_struct_18 =  sum_list(tmp_struct_17.field0, tmp_struct_17.field2);
        clock_gettime(CLOCK_MONOTONIC_RAW, &end);
        if (i < N-1) {
            gib_gc_restore_state(snapshot);
        }
      ...
      case 1:
        {
            ...
            // xs, ys, output
            gib_shadowstack_push(rstack, tmpcur_1362, end_r_615, Stk, List_T);
            gib_shadowstack_push(rstack, ys_37_180_285, end_r_616, Stk, List_T);
            gib_shadowstack_push(wstack, loc_614, end_r_617, Stk, List_T);
            // Pushed.
            ...
            *(GibInt *) writetag_1004 = tmpval_1361;
            ...
            // // xs, ys, output
            // gib_shadowstack_push(rstack, tmpcur_1362, end_r_615, Stk, List_T);
            // gib_shadowstack_push(rstack, r_705, end_r_705, Stk, List_T);
            // gib_shadowstack_push(wstack, loc_614, end_r_617, Stk, List_T);
            // // Pushed.
...
GibInt do_tree(GibInt n_22_186_293)
{
    ...
    /*
    gib_shadowstack_push(rstack, pvrtmp_1408, pvrtmp_1407, Stk, Tree_T);
      ...
      case 1:
        {
            *(GibBoxedTag *) loc_605 = 1;
            ...
            gib_shadowstack_push(rstack, loc_605, end_r_607, Stk, Tree_T);
                                          ...
                                          GibInt n_41_188_294)
{
    ...
    if (fltIf_266_295) {
        ...
        // push to shadow stack.
        gib_shadowstack_push(wstack, loc_651, end_r_652, Stk, Tree_T);
        // pushed.

        // GibChunk region_1413 = gib_alloc_region(19);
        GibChunk region_1413 = gib_alloc_region(1024);
...
*/
        ...
        *(GibBoxedTag *) loc_651 = 1;
        ...
        // push to shadow stack.
        gib_shadowstack_push(rstack, loc_651, end_r_652, Stk, Tree_T);
        // pushed.
...
int gib_main_expr(void)
{
    ...
    // GibInt fltPrd_235_251 =  do_reverse_and_sumlist(gib_get_size_param());
    // printf("reverse: %" PRIu64 "\n", fltPrd_235_251);
