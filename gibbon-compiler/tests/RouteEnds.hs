...
test1 = l$ Ext $ LetRegionE (VarR "r") Undefined Nothing $ l$ Ext $ LetLocE "ltest" (StartOfRegionLE (VarR "r")) $
        ...
        l$ LetE ("x", [], PackedTy "Tree" "ltest1", l$ DataConE "ltest1" "Leaf" [l$ mkLitE64 1]) $
        l$ Ext $ LetLocE "ltest2" (AfterVariableLE "x" "ltest1") $
        l$ LetE ("y", [], PackedTy "Tree" "ltest2", l$ DataConE "ltest2" "Leaf" [l$ mkLitE64 2]) $
...
case_add1_test1 =
  ...
  where
    ...
    prg   = Prog ddfs funs (Just (test1,IntTy W64))
...
--           (LetE (Var "v",[],IntTy W64,PrimAppE addP64 [VarE (Var "n"),mkLitE64 1]) (Ext (RetE [Var "jump1"] (Var "v")))))),
