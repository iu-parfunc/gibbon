...
gcc -std=gnu11  $OPT_LEVEL -flto  -o $GIBBONDIR/gibbon-compiler/examples/gc/Lcss_1.exe -I$GIBBONDIR/gibbon-rts/build -L$GIBBONDIR/gibbon-rts/build -Wl,-rpath=$GIBBONDIR/gibbon-rts/build $GIBBONDIR/gibbon-compiler/examples/gc/Lcss_1.c $GIBBONDIR/gibbon-rts/build/gibbon_rts.o -lm  -lgibbon_rts_ng

gcc -std=gnu11  $OPT_LEVEL  -flto  -o $GIBBONDIR/gibbon-compiler/examples/gc/TreeUpdate_2.exe -I$GIBBONDIR/gibbon-rts/build -L$GIBBONDIR/gibbon-rts/build -Wl,-rpath=$GIBBONDIR/gibbon-rts/build $GIBBONDIR/gibbon-compiler/examples/gc/TreeUpdate_2.c $GIBBONDIR/gibbon-rts/build/gibbon_rts.o -lm  -lgibbon_rts_ng

gcc -std=gnu11  $OPT_LEVEL -flto  -o $GIBBONDIR/gibbon-compiler/examples/gc/Power_1.exe -I$GIBBONDIR/gibbon-rts/build -L$GIBBONDIR/gibbon-rts/build -Wl,-rpath=$GIBBONDIR/gibbon-rts/build $GIBBONDIR/gibbon-compiler/examples/gc/Power_1.c $GIBBONDIR/gibbon-rts/build/gibbon_rts.o -lm  -lgibbon_rts_ng
