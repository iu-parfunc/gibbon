...
tTypeable :: Exp2
tTypeable =  Ext $ LetRegionE (VarR "r500") Undefined $
...
add1MainExp :: Exp2
add1MainExp = Ext $ LetRegionE (VarR "r99") Undefined $
              ...
              LetE ("z105",[],PackedTy "Tree" "l100",
                      DataConE "l100" "Node" [VarE "x102",
                                                 VarE "y104"]) $
              Ext $ LetRegionE (VarR "r106") Undefined $
...
leafMainExp :: Exp2
leafMainExp = Ext $ LetRegionE (VarR "r150") Undefined $
...
-- writes node
nodeMainExp :: Exp2
nodeMainExp = Ext $ LetRegionE (VarR "r155") Undefined $
...
copyTreeMainExp = Ext $ LetRegionE (VarR "r200") Undefined $
                  ...
                  Ext $ LetRegionE (VarR "r207") Undefined $
...
copyOnId1MainExp = Ext $ LetRegionE (VarR "r220") Undefined $
                   ...
                   Ext $ LetRegionE (VarR "r227") Undefined $
...
leftmostMainExp = Ext $ LetRegionE (VarR "r122") Undefined $
...
rightmostBod = CaseE (VarE "t242")
               [("Leaf", [("n246","l247")],
                ...
                ("Node", [("x248","l249"), ("y250","l251")],
                 -- Ext $ LetRegionE (VarR "r252") Undefined $
...
rightmostMainExp = Ext $ LetRegionE (VarR "r253") Undefined $
...
buildLeafMainExp = Ext $ LetRegionE (VarR "r128") Undefined $
...
buildTreeMainExp = Ext $ LetRegionE (VarR "r279") Undefined $
...
buildTwoTreesMainExp = Ext $ LetRegionE (VarR "r756") Undefined $
                       Ext $ LetLocE "l757" (StartOfLE (VarR "r756")) $
                       Ext $ LetRegionE (VarR "r758") Undefined $
...
buildTreeSumMainExp = Ext $ LetRegionE (VarR "r313") Undefined $
...
sumTreeMainExp :: Exp2
sumTreeMainExp = Ext $ LetRegionE (VarR "r771") Undefined $
...
printTupMainExp = Ext $ LetRegionE (VarR "r325") Undefined $
...
printTupMainExp2 = Ext $ LetRegionE (VarR "r400") Undefined $
...
addTreesMainExp = Ext $ LetRegionE (VarR "r400") Undefined $
                  Ext $ LetLocE "l401" (StartOfLE (VarR "r400")) $
                  LetE ("x402",[], PackedTy "Tree" "l401",
                           AppE "buildTree" ["l401"] [LitE 2]) $
                  -- Ext $ LetLocE "l403" (AfterVariableLE "x402" "l401" True) $
                  Ext $ LetRegionE (VarR "r403") Undefined $
                  Ext $ LetLocE "l403" (StartOfLE (VarR "r403")) $
                  LetE ("y404",[], PackedTy "Tree" "l403",
                           AppE "buildTree" ["l403"] [LitE 2]) $
                  LetE ("z405",[], ProdTy [PackedTy "Tree" "l401", PackedTy "Tree" "l403"],
                           MkProdE [VarE "x402", VarE "y404"]) $
                  Ext $ LetRegionE (VarR "r405") Undefined $
...
testFlattenProg = Prog M.empty (M.fromList [("intAdd",intAddFun)]) $ Just (testFlattenBod, IntTy)
  where
    testFlattenBod :: Exp2
    testFlattenBod =
      Ext $ LetRegionE (VarR "_") Undefined $
...
buildSTreeMainExp = Ext $ LetRegionE (VarR "r530") Undefined $
...
sumSTreeMainExp = Ext $ LetRegionE (VarR "r771") Undefined $
                 Ext $ LetLocE "l772" (StartOfLE (VarR "r771")) $
...
sumUpMainExp :: Exp2
sumUpMainExp = Ext $ LetRegionE (VarR "r530") Undefined $
                  Ext $ LetLocE "l531" (StartOfLE (VarR "r530")) $
                  LetE ("x532",[], PackedTy "STree" "l531",
                           AppE "buildSTree" ["l531"] [LitE 2]) $
                  Ext $ LetRegionE (VarR "r536") Undefined $
...
substMainExp :: Exp2
substMainExp = Ext $ LetRegionE (VarR "r720") Undefined $
               ...
               Ext $ LetRegionE (VarR "r728") Undefined $
...
indrBuildTreeMainExp = Ext $ LetRegionE (VarR "r800") Undefined $
...
indrRightmostMainExp = Ext $ LetRegionE (VarR "r753") Undefined $
...
indrIDSumMainExp = Ext $ LetRegionE (VarR "r806") Undefined $
                   Ext $ LetLocE "l807" (StartOfLE (VarR "r806")) $
                   LetE ("tr1",[], PackedTy "Tree" "l807",
