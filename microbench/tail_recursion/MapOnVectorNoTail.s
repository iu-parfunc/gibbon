...
MapOnVectorNoTail.exe:     file format elf64-x86-64
...
/local/scratch/a/singhav/gibbon/gibbon-rts/rts-c/gibbon_rts.c:1900
  ...
  4011b5:	e8 b6 0f 00 00       	call   402170 <gib_check_rust_struct_sizes>
...
/local/scratch/a/singhav/gibbon/gibbon-rts/rts-c/gibbon_rts.c:1877
  ...
  40136b:	e8 a0 0d 00 00       	call   402110 <check_args.part.0>
...
/local/scratch/a/singhav/gibbon/gibbon-rts/rts-c/gibbon_rts.c:1877
  ...
  40139b:	e8 70 0d 00 00       	call   402110 <check_args.part.0>
...
/local/scratch/a/singhav/gibbon/gibbon-rts/rts-c/gibbon_rts.c:2017
    ...
    gib_check_rust_struct_sizes();
  401699:	e8 d2 0a 00 00       	call   402170 <gib_check_rust_struct_sizes>
...
/local/scratch/a/singhav/gibbon/gibbon-compiler/examples/tail_recursion/MapOnVector.c:155
  ...
  4016cc:	e8 9f 09 00 00       	call   402070 <gib_vector_alloc.constprop.0>
...
/local/scratch/a/singhav/gibbon/gibbon-compiler/examples/tail_recursion/MapOnVector.c:159
    GibVector *times_5 = gib_vector_alloc(gib_get_iters_param(),
  4016f6:	e8 75 09 00 00       	call   402070 <gib_vector_alloc.constprop.0>
/local/scratch/a/singhav/gibbon/gibbon-compiler/examples/tail_recursion/MapOnVector.c:164
    for (long long iters_timed_671 = 0; iters_timed_671 < gib_get_iters_param();
...
/local/scratch/a/singhav/gibbon/gibbon-rts/rts-c/gibbon_rts.c:1998
  ...
  401ad7:	e8 44 04 00 00       	call   401f20 <generate_loop_398_536.part.0.isra.0>
  401adc:	e9 5f fd ff ff       	jmp    401840 <main+0x6a0>
  401ae1:	48 8b 7c 24 08       	mov    0x8(%rsp),%rdi
  401ae6:	be 70 36 40 00       	mov    $0x403670,%esi
  401aeb:	e8 20 06 00 00       	call   402110 <check_args.part.0>
  401af0:	e8 4b 06 00 00       	call   402140 <gib_shadowstack_initialize.part.0.constprop.0>
  401af5:	48 8b 7c 24 08       	mov    0x8(%rsp),%rdi
  401afa:	be 5b 36 40 00       	mov    $0x40365b,%esi
  401aff:	e8 0c 06 00 00       	call   402110 <check_args.part.0>
main():
...
/local/scratch/a/singhav/gibbon/gibbon-rts/rts-c/gibbon_rts.c:1425
  ...
  401b70:	e8 9b 05 00 00       	call   402110 <check_args.part.0>
...
/local/scratch/a/singhav/gibbon/gibbon-compiler/examples/tail_recursion/MapOnVector.c:74
  ...
  401baa:	e8 61 05 00 00       	call   402110 <check_args.part.0>
  401baf:	48 8b 7c 24 08       	mov    0x8(%rsp),%rdi
  401bb4:	be ca 36 40 00       	mov    $0x4036ca,%esi
  401bb9:	e8 52 05 00 00       	call   402110 <check_args.part.0>
...
/local/scratch/a/singhav/gibbon/gibbon-rts/rts-c/gibbon_rts.c:1990
  ...
  401c21:	e8 ea 04 00 00       	call   402110 <check_args.part.0>
...
/local/scratch/a/singhav/gibbon/gibbon-compiler/examples/tail_recursion/MapOnVector.c:108
  ...
  401e12:	48 89 c8             	mov    %rcx,%rax
/local/scratch/a/singhav/gibbon/gibbon-compiler/examples/tail_recursion/MapOnVector.c:99
GibVector *generate_loop_398_533(GibVector *vec_166_578_634,
  401e15:	49 89 ce             	mov    %rcx,%r14
  401e18:	41 55                	push   %r13
  401e1a:	49 89 d5             	mov    %rdx,%r13
/local/scratch/a/singhav/gibbon/gibbon-compiler/examples/tail_recursion/MapOnVector.c:108
        GibInt fltPrm_614_641 = n_6_581_637 - idx_167_579_635;
  401e1d:	48 29 f0             	sub    %rsi,%rax
/local/scratch/a/singhav/gibbon/gibbon-compiler/examples/tail_recursion/MapOnVector.c:99
GibVector *generate_loop_398_533(GibVector *vec_166_578_634,
  401e20:	41 54                	push   %r12
  401e22:	49 89 fc             	mov    %rdi,%r12
  401e25:	53                   	push   %rbx
  401e26:	48 89 f3             	mov    %rsi,%rbx
  401e29:	48 83 ec 28          	sub    $0x28,%rsp
generate_loop_398_533.part.0():
/local/scratch/a/singhav/gibbon/gibbon-rts/rts-c/gibbon_rts.c:577
    return ((char*)vec->data + (vec->elt_size * (vec->lower + i)));
  401e2d:	48 8b 57 10          	mov    0x10(%rdi),%rdx
  401e31:	48 8b 3f             	mov    (%rdi),%rdi
generate_loop_398_533():
/local/scratch/a/singhav/gibbon/gibbon-compiler/examples/tail_recursion/MapOnVector.c:108
        GibInt fltPrm_614_641 = n_6_581_637 - idx_167_579_635;
  401e34:	48 89 04 24          	mov    %rax,(%rsp)
/local/scratch/a/singhav/gibbon/gibbon-rts/rts-c/gibbon_rts.c:577
  401e38:	48 01 f7             	add    %rsi,%rdi
generate_loop_398_533.part.0():
/local/scratch/a/singhav/gibbon/gibbon-rts/rts-c/gibbon_rts.c:583
    memcpy(dst, elt, vec->elt_size);
  401e3b:	48 89 e6             	mov    %rsp,%rsi
/local/scratch/a/singhav/gibbon/gibbon-rts/rts-c/gibbon_rts.c:577
    return ((char*)vec->data + (vec->elt_size * (vec->lower + i)));
  401e3e:	48 0f af fa          	imul   %rdx,%rdi
  401e42:	49 03 7c 24 18       	add    0x18(%r12),%rdi
/local/scratch/a/singhav/gibbon/gibbon-rts/rts-c/gibbon_rts.c:583
    memcpy(dst, elt, vec->elt_size);
  401e47:	e8 d4 f2 ff ff       	call   401120 <memcpy@plt>
generate_loop_398_533():
/local/scratch/a/singhav/gibbon/gibbon-compiler/examples/tail_recursion/MapOnVector.c:112
  ...
  401e4c:	48 8d 7b 01          	lea    0x1(%rbx),%rdi
/local/scratch/a/singhav/gibbon/gibbon-compiler/examples/tail_recursion/MapOnVector.c:105
    if (fltIf_613_638) {
  401e50:	4c 39 ef             	cmp    %r13,%rdi
  401e53:	75 13                	jne    401e68 <generate_loop_398_533.part.0+0x58>
/local/scratch/a/singhav/gibbon/gibbon-compiler/examples/tail_recursion/MapOnVector.c:118
}
  401e55:	48 83 c4 28          	add    $0x28,%rsp
  401e59:	4c 89 e0             	mov    %r12,%rax
  401e5c:	5b                   	pop    %rbx
...
/local/scratch/a/singhav/gibbon/gibbon-rts/rts-c/gibbon_rts.c:577
    return ((char*)vec->data + (vec->elt_size * (vec->lower + i)));
  401e68:	49 8b 54 24 10       	mov    0x10(%r12),%rdx
generate_loop_398_533():
/local/scratch/a/singhav/gibbon/gibbon-compiler/examples/tail_recursion/MapOnVector.c:108
        GibInt fltPrm_614_641 = n_6_581_637 - idx_167_579_635;
  401e6d:	4c 89 f0             	mov    %r14,%rax
generate_loop_398_533.part.0():
/local/scratch/a/singhav/gibbon/gibbon-rts/rts-c/gibbon_rts.c:583
    memcpy(dst, elt, vec->elt_size);
  401e70:	48 8d 74 24 08       	lea    0x8(%rsp),%rsi
generate_loop_398_533():
/local/scratch/a/singhav/gibbon/gibbon-compiler/examples/tail_recursion/MapOnVector.c:108
  401e75:	48 29 f8             	sub    %rdi,%rax
/local/scratch/a/singhav/gibbon/gibbon-rts/rts-c/gibbon_rts.c:577
    return ((char*)vec->data + (vec->elt_size * (vec->lower + i)));
  401e78:	49 03 3c 24          	add    (%r12),%rdi
  401e7c:	48 0f af fa          	imul   %rdx,%rdi
  401e80:	49 03 7c 24 18       	add    0x18(%r12),%rdi
/local/scratch/a/singhav/gibbon/gibbon-compiler/examples/tail_recursion/MapOnVector.c:108
  401e85:	48 89 44 24 08       	mov    %rax,0x8(%rsp)
/local/scratch/a/singhav/gibbon/gibbon-rts/rts-c/gibbon_rts.c:583
    memcpy(dst, elt, vec->elt_size);
  401e8a:	e8 91 f2 ff ff       	call   401120 <memcpy@plt>
/local/scratch/a/singhav/gibbon/gibbon-compiler/examples/tail_recursion/MapOnVector.c:112
        GibInt fltAppE_615_643 = idx_167_579_635 + 1;
  401e8f:	48 8d 7b 02          	lea    0x2(%rbx),%rdi
/local/scratch/a/singhav/gibbon/gibbon-compiler/examples/tail_recursion/MapOnVector.c:105
    if (fltIf_613_638) {
  401e93:	49 39 fd             	cmp    %rdi,%r13
  401e96:	74 bd                	je     401e55 <generate_loop_398_533.part.0+0x45>
generate_loop_398_533.part.0():
/local/scratch/a/singhav/gibbon/gibbon-rts/rts-c/gibbon_rts.c:577
    return ((char*)vec->data + (vec->elt_size * (vec->lower + i)));
  401e98:	49 8b 54 24 10       	mov    0x10(%r12),%rdx
generate_loop_398_533():
/local/scratch/a/singhav/gibbon/gibbon-compiler/examples/tail_recursion/MapOnVector.c:108
        GibInt fltPrm_614_641 = n_6_581_637 - idx_167_579_635;
  401e9d:	4c 89 f0             	mov    %r14,%rax
generate_loop_398_533.part.0():
/local/scratch/a/singhav/gibbon/gibbon-rts/rts-c/gibbon_rts.c:583
    memcpy(dst, elt, vec->elt_size);
  401ea0:	48 8d 74 24 10       	lea    0x10(%rsp),%rsi
generate_loop_398_533():
/local/scratch/a/singhav/gibbon/gibbon-compiler/examples/tail_recursion/MapOnVector.c:108
  401ea5:	48 29 f8             	sub    %rdi,%rax
/local/scratch/a/singhav/gibbon/gibbon-rts/rts-c/gibbon_rts.c:577
    return ((char*)vec->data + (vec->elt_size * (vec->lower + i)));
  401ea8:	49 03 3c 24          	add    (%r12),%rdi
  401eac:	48 0f af fa          	imul   %rdx,%rdi
  401eb0:	49 03 7c 24 18       	add    0x18(%r12),%rdi
/local/scratch/a/singhav/gibbon/gibbon-compiler/examples/tail_recursion/MapOnVector.c:108
  401eb5:	48 89 44 24 10       	mov    %rax,0x10(%rsp)
/local/scratch/a/singhav/gibbon/gibbon-rts/rts-c/gibbon_rts.c:583
    memcpy(dst, elt, vec->elt_size);
  401eba:	e8 61 f2 ff ff       	call   401120 <memcpy@plt>
/local/scratch/a/singhav/gibbon/gibbon-compiler/examples/tail_recursion/MapOnVector.c:112
        GibInt fltAppE_615_643 = idx_167_579_635 + 1;
  401ebf:	48 8d 7b 03          	lea    0x3(%rbx),%rdi
/local/scratch/a/singhav/gibbon/gibbon-compiler/examples/tail_recursion/MapOnVector.c:105
    if (fltIf_613_638) {
  401ec3:	49 39 fd             	cmp    %rdi,%r13
  401ec6:	74 8d                	je     401e55 <generate_loop_398_533.part.0+0x45>
generate_loop_398_533.part.0():
/local/scratch/a/singhav/gibbon/gibbon-rts/rts-c/gibbon_rts.c:577
    return ((char*)vec->data + (vec->elt_size * (vec->lower + i)));
  401ec8:	49 8b 54 24 10       	mov    0x10(%r12),%rdx
generate_loop_398_533():
/local/scratch/a/singhav/gibbon/gibbon-compiler/examples/tail_recursion/MapOnVector.c:108
        GibInt fltPrm_614_641 = n_6_581_637 - idx_167_579_635;
  401ecd:	4c 89 f0             	mov    %r14,%rax
generate_loop_398_533.part.0():
/local/scratch/a/singhav/gibbon/gibbon-rts/rts-c/gibbon_rts.c:583
    memcpy(dst, elt, vec->elt_size);
  401ed0:	48 8d 74 24 18       	lea    0x18(%rsp),%rsi
generate_loop_398_533():
/local/scratch/a/singhav/gibbon/gibbon-compiler/examples/tail_recursion/MapOnVector.c:108
  401ed5:	48 29 f8             	sub    %rdi,%rax
/local/scratch/a/singhav/gibbon/gibbon-rts/rts-c/gibbon_rts.c:577
    return ((char*)vec->data + (vec->elt_size * (vec->lower + i)));
  401ed8:	49 03 3c 24          	add    (%r12),%rdi
  401edc:	48 0f af fa          	imul   %rdx,%rdi
  401ee0:	49 03 7c 24 18       	add    0x18(%r12),%rdi
/local/scratch/a/singhav/gibbon/gibbon-compiler/examples/tail_recursion/MapOnVector.c:108
  401ee5:	48 89 44 24 18       	mov    %rax,0x18(%rsp)
/local/scratch/a/singhav/gibbon/gibbon-rts/rts-c/gibbon_rts.c:583
    memcpy(dst, elt, vec->elt_size);
  401eea:	e8 31 f2 ff ff       	call   401120 <memcpy@plt>
/local/scratch/a/singhav/gibbon/gibbon-compiler/examples/tail_recursion/MapOnVector.c:112
        GibInt fltAppE_615_643 = idx_167_579_635 + 1;
  401eef:	48 8d 73 04          	lea    0x4(%rbx),%rsi
/local/scratch/a/singhav/gibbon/gibbon-compiler/examples/tail_recursion/MapOnVector.c:105
    if (fltIf_613_638) {
  401ef3:	49 39 f5             	cmp    %rsi,%r13
  401ef6:	0f 84 59 ff ff ff    	je     401e55 <generate_loop_398_533.part.0+0x45>
  401efc:	4c 89 e7             	mov    %r12,%rdi
  401eff:	4c 89 f1             	mov    %r14,%rcx
  401f02:	4c 89 ea             	mov    %r13,%rdx
  401f05:	e8 06 ff ff ff       	call   401e10 <generate_loop_398_533.part.0>
  401f0a:	49 89 c4             	mov    %rax,%r12
  401f0d:	e9 43 ff ff ff       	jmp    401e55 <generate_loop_398_533.part.0+0x45>
generate_loop_398_533.part.0():
/local/scratch/a/singhav/gibbon/gibbon-compiler/examples/tail_recursion/MapOnVector.c:105
  401f12:	66 66 2e 0f 1f 84 00 	data16 cs nopw 0x0(%rax,%rax,1)
  401f19:	00 00 00 00 
  401f1d:	0f 1f 00             	nopl   (%rax)

0000000000401f20 <generate_loop_398_536.part.0.isra.0>:
generate_loop_398_536():
...
GibVector *generate_loop_398_536(GibVector *vec_166_591_649,
  401f20:	41 55                	push   %r13
  401f22:	49 89 d5             	mov    %rdx,%r13
  401f25:	41 54                	push   %r12
  401f27:	49 89 cc             	mov    %rcx,%r12
  401f2a:	55                   	push   %rbp
  401f2b:	48 89 fd             	mov    %rdi,%rbp
  401f2e:	53                   	push   %rbx
  401f2f:	48 89 f3             	mov    %rsi,%rbx
  401f32:	48 83 ec 28          	sub    $0x28,%rsp
generate_loop_398_536.part.0.isra.0():
/local/scratch/a/singhav/gibbon/gibbon-rts/rts-c/gibbon_rts.c:577
    return ((char*)vec->data + (vec->elt_size * (vec->lower + i)));
  401f36:	48 8b 01             	mov    (%rcx),%rax
generate_loop_398_536():
/local/scratch/a/singhav/gibbon/gibbon-compiler/examples/tail_recursion/MapOnVector.c:132
        GibInt fltAppE_618_656 = *tmp_0;
  401f39:	48 8b 51 18          	mov    0x18(%rcx),%rdx
/local/scratch/a/singhav/gibbon/gibbon-rts/rts-c/gibbon_rts.c:577
  401f3d:	48 01 f0             	add    %rsi,%rax
  401f40:	48 0f af 41 10       	imul   0x10(%rcx),%rax
add1():
/local/scratch/a/singhav/gibbon/gibbon-compiler/examples/tail_recursion/MapOnVector.c:85
    GibInt tailprim_667 = x_10_552_630 + 1;
  401f45:	48 8b 04 02          	mov    (%rdx,%rax,1),%rax
generate_loop_398_536.part.0.isra.0():
/local/scratch/a/singhav/gibbon/gibbon-rts/rts-c/gibbon_rts.c:577
  401f49:	48 8b 57 10          	mov    0x10(%rdi),%rdx
  401f4d:	48 8b 3f             	mov    (%rdi),%rdi
add1():
/local/scratch/a/singhav/gibbon/gibbon-compiler/examples/tail_recursion/MapOnVector.c:85
  401f50:	48 83 c0 01          	add    $0x1,%rax
/local/scratch/a/singhav/gibbon/gibbon-rts/rts-c/gibbon_rts.c:577
  401f54:	48 01 f7             	add    %rsi,%rdi
generate_loop_398_536.part.0.isra.0():
/local/scratch/a/singhav/gibbon/gibbon-rts/rts-c/gibbon_rts.c:583
    memcpy(dst, elt, vec->elt_size);
  401f57:	48 89 e6             	mov    %rsp,%rsi
generate_loop_398_536():
/local/scratch/a/singhav/gibbon/gibbon-compiler/examples/tail_recursion/MapOnVector.c:133
  ...
  401f5a:	48 89 04 24          	mov    %rax,(%rsp)
/local/scratch/a/singhav/gibbon/gibbon-rts/rts-c/gibbon_rts.c:577
    return ((char*)vec->data + (vec->elt_size * (vec->lower + i)));
  401f5e:	48 0f af fa          	imul   %rdx,%rdi
  401f62:	48 03 7d 18          	add    0x18(%rbp),%rdi
/local/scratch/a/singhav/gibbon/gibbon-rts/rts-c/gibbon_rts.c:583
    memcpy(dst, elt, vec->elt_size);
  401f66:	e8 b5 f1 ff ff       	call   401120 <memcpy@plt>
/local/scratch/a/singhav/gibbon/gibbon-compiler/examples/tail_recursion/MapOnVector.c:137
  ...
  401f6b:	48 8d 7b 01          	lea    0x1(%rbx),%rdi
/local/scratch/a/singhav/gibbon/gibbon-compiler/examples/tail_recursion/MapOnVector.c:125
    if (fltIf_616_653) {
  401f6f:	4c 39 ef             	cmp    %r13,%rdi
  401f72:	75 0c                	jne    401f80 <generate_loop_398_536.part.0.isra.0+0x60>
/local/scratch/a/singhav/gibbon/gibbon-compiler/examples/tail_recursion/MapOnVector.c:143
}
  401f74:	48 83 c4 28          	add    $0x28,%rsp
  401f78:	5b                   	pop    %rbx
  401f79:	5d                   	pop    %rbp
...
/local/scratch/a/singhav/gibbon/gibbon-rts/rts-c/gibbon_rts.c:577
    return ((char*)vec->data + (vec->elt_size * (vec->lower + i)));
  401f80:	49 8b 04 24          	mov    (%r12),%rax
generate_loop_398_536():
/local/scratch/a/singhav/gibbon/gibbon-compiler/examples/tail_recursion/MapOnVector.c:132
        GibInt fltAppE_618_656 = *tmp_0;
  401f84:	49 8b 54 24 18       	mov    0x18(%r12),%rdx
generate_loop_398_536.part.0.isra.0():
/local/scratch/a/singhav/gibbon/gibbon-rts/rts-c/gibbon_rts.c:583
    memcpy(dst, elt, vec->elt_size);
  401f89:	48 8d 74 24 08       	lea    0x8(%rsp),%rsi
/local/scratch/a/singhav/gibbon/gibbon-rts/rts-c/gibbon_rts.c:577
    return ((char*)vec->data + (vec->elt_size * (vec->lower + i)));
  401f8e:	48 01 f8             	add    %rdi,%rax
  401f91:	49 0f af 44 24 10    	imul   0x10(%r12),%rax
  401f97:	48 03 7d 00          	add    0x0(%rbp),%rdi
add1():
/local/scratch/a/singhav/gibbon/gibbon-compiler/examples/tail_recursion/MapOnVector.c:85
    GibInt tailprim_667 = x_10_552_630 + 1;
  401f9b:	48 8b 04 02          	mov    (%rdx,%rax,1),%rax
/local/scratch/a/singhav/gibbon/gibbon-rts/rts-c/gibbon_rts.c:577
  401f9f:	48 8b 55 10          	mov    0x10(%rbp),%rdx
/local/scratch/a/singhav/gibbon/gibbon-compiler/examples/tail_recursion/MapOnVector.c:85
  401fa3:	48 83 c0 01          	add    $0x1,%rax
/local/scratch/a/singhav/gibbon/gibbon-rts/rts-c/gibbon_rts.c:577
  401fa7:	48 0f af fa          	imul   %rdx,%rdi
  401fab:	48 03 7d 18          	add    0x18(%rbp),%rdi
generate_loop_398_536():
/local/scratch/a/singhav/gibbon/gibbon-compiler/examples/tail_recursion/MapOnVector.c:133
        GibInt fltPrm_617_657 =  add1(fltAppE_618_656);
  401faf:	48 89 44 24 08       	mov    %rax,0x8(%rsp)
/local/scratch/a/singhav/gibbon/gibbon-rts/rts-c/gibbon_rts.c:583
    memcpy(dst, elt, vec->elt_size);
  401fb4:	e8 67 f1 ff ff       	call   401120 <memcpy@plt>
/local/scratch/a/singhav/gibbon/gibbon-compiler/examples/tail_recursion/MapOnVector.c:137
        GibInt fltAppE_619_659 = idx_167_592_650 + 1;
  401fb9:	48 8d 7b 02          	lea    0x2(%rbx),%rdi
/local/scratch/a/singhav/gibbon/gibbon-compiler/examples/tail_recursion/MapOnVector.c:125
    if (fltIf_616_653) {
  401fbd:	49 39 fd             	cmp    %rdi,%r13
  401fc0:	74 b2                	je     401f74 <generate_loop_398_536.part.0.isra.0+0x54>
generate_loop_398_536.part.0.isra.0():
/local/scratch/a/singhav/gibbon/gibbon-rts/rts-c/gibbon_rts.c:577
    return ((char*)vec->data + (vec->elt_size * (vec->lower + i)));
  401fc2:	49 8b 04 24          	mov    (%r12),%rax
generate_loop_398_536():
/local/scratch/a/singhav/gibbon/gibbon-compiler/examples/tail_recursion/MapOnVector.c:132
        GibInt fltAppE_618_656 = *tmp_0;
  401fc6:	49 8b 54 24 18       	mov    0x18(%r12),%rdx
generate_loop_398_536.part.0.isra.0():
/local/scratch/a/singhav/gibbon/gibbon-rts/rts-c/gibbon_rts.c:583
    memcpy(dst, elt, vec->elt_size);
  401fcb:	48 8d 74 24 10       	lea    0x10(%rsp),%rsi
/local/scratch/a/singhav/gibbon/gibbon-rts/rts-c/gibbon_rts.c:577
    return ((char*)vec->data + (vec->elt_size * (vec->lower + i)));
  401fd0:	48 01 f8             	add    %rdi,%rax
  401fd3:	49 0f af 44 24 10    	imul   0x10(%r12),%rax
  401fd9:	48 03 7d 00          	add    0x0(%rbp),%rdi
add1():
/local/scratch/a/singhav/gibbon/gibbon-compiler/examples/tail_recursion/MapOnVector.c:85
    GibInt tailprim_667 = x_10_552_630 + 1;
  401fdd:	48 8b 04 02          	mov    (%rdx,%rax,1),%rax
/local/scratch/a/singhav/gibbon/gibbon-rts/rts-c/gibbon_rts.c:577
  401fe1:	48 8b 55 10          	mov    0x10(%rbp),%rdx
/local/scratch/a/singhav/gibbon/gibbon-compiler/examples/tail_recursion/MapOnVector.c:85
  401fe5:	48 83 c0 01          	add    $0x1,%rax
/local/scratch/a/singhav/gibbon/gibbon-rts/rts-c/gibbon_rts.c:577
  401fe9:	48 0f af fa          	imul   %rdx,%rdi
  401fed:	48 03 7d 18          	add    0x18(%rbp),%rdi
generate_loop_398_536():
/local/scratch/a/singhav/gibbon/gibbon-compiler/examples/tail_recursion/MapOnVector.c:133
        GibInt fltPrm_617_657 =  add1(fltAppE_618_656);
  401ff1:	48 89 44 24 10       	mov    %rax,0x10(%rsp)
/local/scratch/a/singhav/gibbon/gibbon-rts/rts-c/gibbon_rts.c:583
    memcpy(dst, elt, vec->elt_size);
  401ff6:	e8 25 f1 ff ff       	call   401120 <memcpy@plt>
/local/scratch/a/singhav/gibbon/gibbon-compiler/examples/tail_recursion/MapOnVector.c:137
        GibInt fltAppE_619_659 = idx_167_592_650 + 1;
  401ffb:	48 8d 7b 03          	lea    0x3(%rbx),%rdi
/local/scratch/a/singhav/gibbon/gibbon-compiler/examples/tail_recursion/MapOnVector.c:125
    if (fltIf_616_653) {
  401fff:	49 39 fd             	cmp    %rdi,%r13
  402002:	0f 84 6c ff ff ff    	je     401f74 <generate_loop_398_536.part.0.isra.0+0x54>
generate_loop_398_536.part.0.isra.0():
/local/scratch/a/singhav/gibbon/gibbon-rts/rts-c/gibbon_rts.c:577
    return ((char*)vec->data + (vec->elt_size * (vec->lower + i)));
  402008:	49 8b 04 24          	mov    (%r12),%rax
generate_loop_398_536():
/local/scratch/a/singhav/gibbon/gibbon-compiler/examples/tail_recursion/MapOnVector.c:132
        GibInt fltAppE_618_656 = *tmp_0;
  40200c:	49 8b 54 24 18       	mov    0x18(%r12),%rdx
generate_loop_398_536.part.0.isra.0():
/local/scratch/a/singhav/gibbon/gibbon-rts/rts-c/gibbon_rts.c:583
    memcpy(dst, elt, vec->elt_size);
  402011:	48 8d 74 24 18       	lea    0x18(%rsp),%rsi
/local/scratch/a/singhav/gibbon/gibbon-rts/rts-c/gibbon_rts.c:577
    return ((char*)vec->data + (vec->elt_size * (vec->lower + i)));
  402016:	48 01 f8             	add    %rdi,%rax
  402019:	49 0f af 44 24 10    	imul   0x10(%r12),%rax
  40201f:	48 03 7d 00          	add    0x0(%rbp),%rdi
add1():
/local/scratch/a/singhav/gibbon/gibbon-compiler/examples/tail_recursion/MapOnVector.c:85
    GibInt tailprim_667 = x_10_552_630 + 1;
  402023:	48 8b 04 02          	mov    (%rdx,%rax,1),%rax
/local/scratch/a/singhav/gibbon/gibbon-rts/rts-c/gibbon_rts.c:577
  402027:	48 8b 55 10          	mov    0x10(%rbp),%rdx
/local/scratch/a/singhav/gibbon/gibbon-compiler/examples/tail_recursion/MapOnVector.c:85
  40202b:	48 83 c0 01          	add    $0x1,%rax
/local/scratch/a/singhav/gibbon/gibbon-rts/rts-c/gibbon_rts.c:577
  40202f:	48 0f af fa          	imul   %rdx,%rdi
  402033:	48 03 7d 18          	add    0x18(%rbp),%rdi
generate_loop_398_536():
/local/scratch/a/singhav/gibbon/gibbon-compiler/examples/tail_recursion/MapOnVector.c:133
        GibInt fltPrm_617_657 =  add1(fltAppE_618_656);
  402037:	48 89 44 24 18       	mov    %rax,0x18(%rsp)
/local/scratch/a/singhav/gibbon/gibbon-rts/rts-c/gibbon_rts.c:583
    memcpy(dst, elt, vec->elt_size);
  40203c:	e8 df f0 ff ff       	call   401120 <memcpy@plt>
/local/scratch/a/singhav/gibbon/gibbon-compiler/examples/tail_recursion/MapOnVector.c:137
        GibInt fltAppE_619_659 = idx_167_592_650 + 1;
  402041:	48 8d 73 04          	lea    0x4(%rbx),%rsi
/local/scratch/a/singhav/gibbon/gibbon-compiler/examples/tail_recursion/MapOnVector.c:125
    if (fltIf_616_653) {
  402045:	49 39 f5             	cmp    %rsi,%r13
  402048:	0f 84 26 ff ff ff    	je     401f74 <generate_loop_398_536.part.0.isra.0+0x54>
  40204e:	4c 89 e1             	mov    %r12,%rcx
  402051:	4c 89 ea             	mov    %r13,%rdx
  402054:	48 89 ef             	mov    %rbp,%rdi
  402057:	e8 c4 fe ff ff       	call   401f20 <generate_loop_398_536.part.0.isra.0>
  40205c:	e9 13 ff ff ff       	jmp    401f74 <generate_loop_398_536.part.0.isra.0+0x54>
generate_loop_398_536.part.0.isra.0():
/local/scratch/a/singhav/gibbon/gibbon-compiler/examples/tail_recursion/MapOnVector.c:125
  402061:	66 66 2e 0f 1f 84 00 	data16 cs nopw 0x0(%rax,%rax,1)
  402068:	00 00 00 00 
  40206c:	0f 1f 40 00          	nopl   0x0(%rax)

0000000000402070 <gib_vector_alloc.constprop.0>:
...
GibVector *gib_vector_alloc(GibInt num, size_t elt_size)
  402070:	41 54                	push   %r12
  402072:	53                   	push   %rbx
  402073:	48 89 fb             	mov    %rdi,%rbx
/local/scratch/a/singhav/gibbon/gibbon-rts/rts-c/gibbon_rts.c:241
void *gib_alloc(size_t n) { return malloc(n); }
  402076:	bf 20 00 00 00       	mov    $0x20,%edi
/local/scratch/a/singhav/gibbon/gibbon-rts/rts-c/gibbon_rts.c:512
GibVector *gib_vector_alloc(GibInt num, size_t elt_size)
  40207b:	48 83 ec 08          	sub    $0x8,%rsp
/local/scratch/a/singhav/gibbon/gibbon-rts/rts-c/gibbon_rts.c:241
void *gib_alloc(size_t n) { return malloc(n); }
  40207f:	e8 ac f0 ff ff       	call   401130 <malloc@plt>
/local/scratch/a/singhav/gibbon/gibbon-rts/rts-c/gibbon_rts.c:515
    if (vec == NULL) {
  402084:	48 85 c0             	test   %rax,%rax
  402087:	74 3b                	je     4020c4 <gib_vector_alloc.constprop.0+0x54>
/local/scratch/a/singhav/gibbon/gibbon-rts/rts-c/gibbon_rts.c:519
    void *data = (void *) gib_alloc(num * elt_size);
  402089:	48 8d 3c dd 00 00 00 	lea    0x0(,%rbx,8),%rdi
  402090:	00 
  402091:	49 89 c4             	mov    %rax,%r12
/local/scratch/a/singhav/gibbon/gibbon-rts/rts-c/gibbon_rts.c:241
void *gib_alloc(size_t n) { return malloc(n); }
  402094:	e8 97 f0 ff ff       	call   401130 <malloc@plt>
/local/scratch/a/singhav/gibbon/gibbon-rts/rts-c/gibbon_rts.c:520
    if (data == NULL) {
  402099:	48 85 c0             	test   %rax,%rax
  40209c:	74 48                	je     4020e6 <gib_vector_alloc.constprop.0+0x76>
/local/scratch/a/singhav/gibbon/gibbon-rts/rts-c/gibbon_rts.c:527
    vec->data = data;
  40209e:	49 89 44 24 18       	mov    %rax,0x18(%r12)
/local/scratch/a/singhav/gibbon/gibbon-rts/rts-c/gibbon_rts.c:529
}
  4020a3:	4c 89 e0             	mov    %r12,%rax
/local/scratch/a/singhav/gibbon/gibbon-rts/rts-c/gibbon_rts.c:524
    vec->lower = 0;
  4020a6:	49 c7 04 24 00 00 00 	movq   $0x0,(%r12)
  4020ad:	00 
/local/scratch/a/singhav/gibbon/gibbon-rts/rts-c/gibbon_rts.c:525
    vec->upper = num;
  4020ae:	49 89 5c 24 08       	mov    %rbx,0x8(%r12)
/local/scratch/a/singhav/gibbon/gibbon-rts/rts-c/gibbon_rts.c:526
    vec->elt_size = elt_size;
  4020b3:	49 c7 44 24 10 08 00 	movq   $0x8,0x10(%r12)
  4020ba:	00 00 
/local/scratch/a/singhav/gibbon/gibbon-rts/rts-c/gibbon_rts.c:529
}
  4020bc:	48 83 c4 08          	add    $0x8,%rsp
  4020c0:	5b                   	pop    %rbx
  4020c1:	41 5c                	pop    %r12
  4020c3:	c3                   	ret
/local/scratch/a/singhav/gibbon/gibbon-rts/rts-c/gibbon_rts.c:516
        fprintf(stderr, "alloc_vector: gib_alloc failed: %zu", sizeof(GibVector));
  4020c4:	48 8b 3d 35 30 00 00 	mov    0x3035(%rip),%rdi        # 405100 <stderr@GLIBC_2.2.5>
  4020cb:	ba 20 00 00 00       	mov    $0x20,%edx
  4020d0:	be 18 33 40 00       	mov    $0x403318,%esi
  4020d5:	31 c0                	xor    %eax,%eax
  4020d7:	e8 34 f0 ff ff       	call   401110 <fprintf@plt>
/local/scratch/a/singhav/gibbon/gibbon-rts/rts-c/gibbon_rts.c:517
        exit(1);
  4020dc:	bf 01 00 00 00       	mov    $0x1,%edi
  4020e1:	e8 8a f0 ff ff       	call   401170 <exit@plt>
/local/scratch/a/singhav/gibbon/gibbon-rts/rts-c/gibbon_rts.c:521
        fprintf(stderr, "alloc_vector: gib_alloc failed: %zu", sizeof(num * elt_size));
  4020e6:	48 8b 3d 13 30 00 00 	mov    0x3013(%rip),%rdi        # 405100 <stderr@GLIBC_2.2.5>
  4020ed:	ba 08 00 00 00       	mov    $0x8,%edx
  4020f2:	be 18 33 40 00       	mov    $0x403318,%esi
  4020f7:	e8 14 f0 ff ff       	call   401110 <fprintf@plt>
/local/scratch/a/singhav/gibbon/gibbon-rts/rts-c/gibbon_rts.c:522
        exit(1);
  4020fc:	bf 01 00 00 00       	mov    $0x1,%edi
  402101:	e8 6a f0 ff ff       	call   401170 <exit@plt>
  402106:	66 2e 0f 1f 84 00 00 	cs nopw 0x0(%rax,%rax,1)
  40210d:	00 00 00 

0000000000402110 <check_args.part.0>:
check_args.part.0():
...
/local/scratch/a/singhav/gibbon/gibbon-rts/rts-c/gibbon_rts.c:1878
  ...
  402114:	48 8b 3d e5 2f 00 00 	mov    0x2fe5(%rip),%rdi        # 405100 <stderr@GLIBC_2.2.5>
/local/scratch/a/singhav/gibbon/gibbon-rts/rts-c/gibbon_rts.c:1876
void check_args(int i, int argc, char **argv, char *parameter){
  40211b:	48 89 f2             	mov    %rsi,%rdx
/local/scratch/a/singhav/gibbon/gibbon-rts/rts-c/gibbon_rts.c:1878
        fprintf(stderr, "Not enough arguments after %s, expected <int>.\n", parameter);
  40211e:	31 c0                	xor    %eax,%eax
  402120:	be 40 33 40 00       	mov    $0x403340,%esi
  402125:	e8 e6 ef ff ff       	call   401110 <fprintf@plt>
/local/scratch/a/singhav/gibbon/gibbon-rts/rts-c/gibbon_rts.c:1879
        gib_show_usage(argv);
  40212a:	48 89 ef             	mov    %rbp,%rdi
  40212d:	e8 1e fc ff ff       	call   401d50 <gib_show_usage>
/local/scratch/a/singhav/gibbon/gibbon-rts/rts-c/gibbon_rts.c:1880
        exit(1);
  402132:	bf 01 00 00 00       	mov    $0x1,%edi
  402137:	e8 34 f0 ff ff       	call   401170 <exit@plt>
  40213c:	0f 1f 40 00          	nopl   0x0(%rax)

0000000000402140 <gib_shadowstack_initialize.part.0.constprop.0>:
...
/local/scratch/a/singhav/gibbon/gibbon-rts/rts-c/gibbon_rts.c:1487
  ...
  402144:	ba 00 00 00 06       	mov    $0x6000000,%edx
  402149:	be 70 33 40 00       	mov    $0x403370,%esi
  40214e:	31 c0                	xor    %eax,%eax
  402150:	48 8b 3d a9 2f 00 00 	mov    0x2fa9(%rip),%rdi        # 405100 <stderr@GLIBC_2.2.5>
  402157:	e8 b4 ef ff ff       	call   401110 <fprintf@plt>
/local/scratch/a/singhav/gibbon/gibbon-rts/rts-c/gibbon_rts.c:1489
        exit(1);
  40215c:	bf 01 00 00 00       	mov    $0x1,%edi
  402161:	e8 0a f0 ff ff       	call   401170 <exit@plt>
  402166:	66 2e 0f 1f 84 00 00 	cs nopw 0x0(%rax,%rax,1)
  40216d:	00 00 00 

0000000000402170 <gib_check_rust_struct_sizes>:
gib_check_rust_struct_sizes():
...
/local/scratch/a/singhav/gibbon/gibbon-rts/rts-c/gibbon_rts.c:241
void *gib_alloc(size_t n) { return malloc(n); }
  402171:	bf 38 00 00 00       	mov    $0x38,%edi
  402176:	e8 b5 ef ff ff       	call   401130 <malloc@plt>
...
/local/scratch/a/singhav/gibbon/gibbon-rts/rts-c/gibbon_rts.c:242
void gib_free(void *ptr) { free(ptr); }
  4021e9:	e9 42 ee ff ff       	jmp    401030 <free@plt>
/local/scratch/a/singhav/gibbon/gibbon-rts/rts-c/gibbon_rts.c:1007 (discriminator 1)
    assert(*stack == sizeof(GibShadowstack));
  4021ee:	b9 60 37 40 00       	mov    $0x403760,%ecx
  4021f3:	ba ef 03 00 00       	mov    $0x3ef,%edx
  4021f8:	be a8 33 40 00       	mov    $0x4033a8,%esi
  4021fd:	bf e8 33 40 00       	mov    $0x4033e8,%edi
  402202:	e8 c9 ee ff ff       	call   4010d0 <__assert_fail@plt>
/local/scratch/a/singhav/gibbon/gibbon-rts/rts-c/gibbon_rts.c:1013 (discriminator 1)
    assert(*gc_stats == sizeof(GibGcStats));
  402207:	b9 60 37 40 00       	mov    $0x403760,%ecx
  40220c:	ba f5 03 00 00       	mov    $0x3f5,%edx
  402211:	be a8 33 40 00       	mov    $0x4033a8,%esi
  402216:	bf d0 34 40 00       	mov    $0x4034d0,%edi
  40221b:	e8 b0 ee ff ff       	call   4010d0 <__assert_fail@plt>
/local/scratch/a/singhav/gibbon/gibbon-rts/rts-c/gibbon_rts.c:1012 (discriminator 1)
    assert(*footer == sizeof(GibOldgenChunkFooter));
  402220:	b9 60 37 40 00       	mov    $0x403760,%ecx
  402225:	ba f4 03 00 00       	mov    $0x3f4,%edx
  40222a:	be a8 33 40 00       	mov    $0x4033a8,%esi
  40222f:	bf a8 34 40 00       	mov    $0x4034a8,%edi
  402234:	e8 97 ee ff ff       	call   4010d0 <__assert_fail@plt>
/local/scratch/a/singhav/gibbon/gibbon-rts/rts-c/gibbon_rts.c:1011 (discriminator 1)
    assert(*reg_info == sizeof(GibRegionInfo));
  402239:	b9 60 37 40 00       	mov    $0x403760,%ecx
  40223e:	ba f3 03 00 00       	mov    $0x3f3,%edx
  402243:	be a8 33 40 00       	mov    $0x4033a8,%esi
  402248:	bf 80 34 40 00       	mov    $0x403480,%edi
  40224d:	e8 7e ee ff ff       	call   4010d0 <__assert_fail@plt>
/local/scratch/a/singhav/gibbon/gibbon-rts/rts-c/gibbon_rts.c:1010 (discriminator 1)
    assert(*generation == sizeof(GibOldgen));
  402252:	b9 60 37 40 00       	mov    $0x403760,%ecx
  402257:	ba f2 03 00 00       	mov    $0x3f2,%edx
  40225c:	be a8 33 40 00       	mov    $0x4033a8,%esi
  402261:	bf 58 34 40 00       	mov    $0x403458,%edi
  402266:	e8 65 ee ff ff       	call   4010d0 <__assert_fail@plt>
/local/scratch/a/singhav/gibbon/gibbon-rts/rts-c/gibbon_rts.c:1009 (discriminator 1)
    assert(*nursery == sizeof(GibNursery));
  40226b:	b9 60 37 40 00       	mov    $0x403760,%ecx
  402270:	ba f1 03 00 00       	mov    $0x3f1,%edx
  402275:	be a8 33 40 00       	mov    $0x4033a8,%esi
  40227a:	bf 38 34 40 00       	mov    $0x403438,%edi
  40227f:	e8 4c ee ff ff       	call   4010d0 <__assert_fail@plt>
/local/scratch/a/singhav/gibbon/gibbon-rts/rts-c/gibbon_rts.c:1008 (discriminator 1)
    assert(*frame == sizeof(GibShadowstackFrame));
  402284:	b9 60 37 40 00       	mov    $0x403760,%ecx
  402289:	ba f0 03 00 00       	mov    $0x3f0,%edx
  40228e:	be a8 33 40 00       	mov    $0x4033a8,%esi
  402293:	bf 10 34 40 00       	mov    $0x403410,%edi
  402298:	e8 33 ee ff ff       	call   4010d0 <__assert_fail@plt>

Disassembly of section .fini:

00000000004022a0 <_fini>:
_fini():
