...
int main(){
 ...
 SoAList copyLocationMkListOut;
 copyLocationMkListOut.tagRegion = mkListOut->tagRegion;
 copyLocationMkListOut.IntRegion = mkListOut->IntRegion;
 ...
 SoAList *Add1SoAOut = add1RecursiveInPlace(mkListOut, &copyLocationMkListOut);
