...
This is a thin parent script around
`gibbon-compiler/examples/soa_examples/gibbon_benchmark.py`.  It runs the
benchmark configurations needed to compare the built-in layout/optimization
variants and combines their JSON outputs into one Markdown
report:
...
BENCH_DIR = REPO_ROOT / "gibbon-compiler" / "examples" / "soa_examples"
